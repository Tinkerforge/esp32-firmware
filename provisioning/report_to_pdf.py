...
Z\textsubscript{{L-PE}}  & {tests["zauto_L1"]["results"]["ZLPE_Auto"].replace(".", ",").replace("Ohm", r"$\Omega$")} & {tests["zauto_L2"]["results"]["ZLPE_Auto"].replace(".", ",").replace("Ohm", r"$\Omega$")} & {tests["zauto_L3"]["results"]["ZLPE_Auto"].replace(".", ",").replace("Ohm", r"$\Omega$")} & \\
