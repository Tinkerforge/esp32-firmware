...
from provisioning.tinkerforge.ip_connection import base58decode
...
def main():
    ...
    mac_address = check_if_esp_is_sane_and_get_mac(ignore_flash_errors=True, allowed_revision=[3.0, 3.1])
