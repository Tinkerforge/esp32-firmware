...
typedef void (*TF_BarometerV2_AirPressureHandler)(struct TF_BarometerV2 *barometer_v2, int32_t air_pressure, void *user_data);
typedef void (*TF_BarometerV2_AltitudeHandler)(struct TF_BarometerV2 *barometer_v2, int32_t altitude, void *user_data);
typedef void (*TF_BarometerV2_TemperatureHandler)(struct TF_BarometerV2 *barometer_v2, int32_t temperature, void *user_data);
