...
int tf_co2_v2_create(TF_CO2V2 *co2_v2, const char *uid_or_port_name, TF_HAL *hal) {
    ...
    TF_TFP *tfp;
    int rc = tf_hal_get_attachable_tfp(hal, &tfp, uid_or_port_name, TF_CO2_V2_DEVICE_IDENTIFIER);
...
int tf_co2_v2_get_all_values(TF_CO2V2 *co2_v2, uint16_t *ret_co2_concentration, int16_t *ret_temperature, uint16_t *ret_humidity) {
    ...
    tf_tfp_prepare_send(co2_v2->tfp, TF_CO2_V2_FUNCTION_GET_ALL_VALUES, 0, _response_expected);

    uint32_t _deadline = tf_hal_current_time_us(_hal) + tf_hal_get_common(_hal)->timeout;

    uint8_t _error_code = 0;
    uint8_t _length = 0;
    int _result = tf_tfp_send_packet(co2_v2->tfp, _response_expected, _deadline, &_error_code, &_length, TF_NEW_PACKET);
    ...
    if (_result & TF_TICK_PACKET_RECEIVED) {
        TF_PacketBuffer *_recv_buf = tf_tfp_get_receive_buffer(co2_v2->tfp);
        if (_error_code != 0 || _length != 6) {
            tf_packet_buffer_remove(_recv_buf, _length);
        } else {
            if (ret_co2_concentration != NULL) { *ret_co2_concentration = tf_packet_buffer_read_uint16_t(_recv_buf); } else { tf_packet_buffer_remove(_recv_buf, 2); }
...
int tf_co2_v2_set_air_pressure(TF_CO2V2 *co2_v2, uint16_t air_pressure) {
    ...
    bool _response_expected = true;
    tf_co2_v2_get_response_expected(co2_v2, TF_CO2_V2_FUNCTION_SET_AIR_PRESSURE, &_response_expected);
    tf_tfp_prepare_send(co2_v2->tfp, TF_CO2_V2_FUNCTION_SET_AIR_PRESSURE, 2, _response_expected);

    uint8_t *_send_buf = tf_tfp_get_send_payload_buffer(co2_v2->tfp);

    air_pressure = tf_leconvert_uint16_to(air_pressure); memcpy(_send_buf + 0, &air_pressure, 2);
...
int tf_co2_v2_get_air_pressure(TF_CO2V2 *co2_v2, uint16_t *ret_air_pressure) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(co2_v2->tfp, TF_CO2_V2_FUNCTION_GET_AIR_PRESSURE, 0, _response_expected);
    ...
    if (_result & TF_TICK_PACKET_RECEIVED) {
        ...
        if (_error_code != 0 || _length != 2) {
            ...
            if (ret_air_pressure != NULL) { *ret_air_pressure = tf_packet_buffer_read_uint16_t(_recv_buf); } else { tf_packet_buffer_remove(_recv_buf, 2); }
        }
        tf_tfp_packet_processed(co2_v2->tfp);
    }
...
int tf_co2_v2_set_temperature_offset(TF_CO2V2 *co2_v2, uint16_t offset) {
    ...
    bool _response_expected = true;
    tf_co2_v2_get_response_expected(co2_v2, TF_CO2_V2_FUNCTION_SET_TEMPERATURE_OFFSET, &_response_expected);
    tf_tfp_prepare_send(co2_v2->tfp, TF_CO2_V2_FUNCTION_SET_TEMPERATURE_OFFSET, 2, _response_expected);

    uint8_t *_send_buf = tf_tfp_get_send_payload_buffer(co2_v2->tfp);

    offset = tf_leconvert_uint16_to(offset); memcpy(_send_buf + 0, &offset, 2);
...
int tf_co2_v2_get_temperature_offset(TF_CO2V2 *co2_v2, uint16_t *ret_offset) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(co2_v2->tfp, TF_CO2_V2_FUNCTION_GET_TEMPERATURE_OFFSET, 0, _response_expected);
    ...
    if (_result & TF_TICK_PACKET_RECEIVED) {
        ...
        if (_error_code != 0 || _length != 2) {
            ...
            if (ret_offset != NULL) { *ret_offset = tf_packet_buffer_read_uint16_t(_recv_buf); } else { tf_packet_buffer_remove(_recv_buf, 2); }
        }
        tf_tfp_packet_processed(co2_v2->tfp);
    }
...
int tf_co2_v2_set_all_values_callback_configuration(TF_CO2V2 *co2_v2, uint32_t period, bool value_has_to_change) {
    ...
    bool _response_expected = true;
    tf_co2_v2_get_response_expected(co2_v2, TF_CO2_V2_FUNCTION_SET_ALL_VALUES_CALLBACK_CONFIGURATION, &_response_expected);
    tf_tfp_prepare_send(co2_v2->tfp, TF_CO2_V2_FUNCTION_SET_ALL_VALUES_CALLBACK_CONFIGURATION, 5, _response_expected);
...
int tf_co2_v2_get_all_values_callback_configuration(TF_CO2V2 *co2_v2, uint32_t *ret_period, bool *ret_value_has_to_change) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(co2_v2->tfp, TF_CO2_V2_FUNCTION_GET_ALL_VALUES_CALLBACK_CONFIGURATION, 0, _response_expected);
...
int tf_co2_v2_get_co2_concentration(TF_CO2V2 *co2_v2, uint16_t *ret_co2_concentration) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(co2_v2->tfp, TF_CO2_V2_FUNCTION_GET_CO2_CONCENTRATION, 0, _response_expected);
...
int tf_co2_v2_set_co2_concentration_callback_configuration(TF_CO2V2 *co2_v2, uint32_t period, bool value_has_to_change, char option, uint16_t min, uint16_t max) {
    ...
    bool _response_expected = true;
    tf_co2_v2_get_response_expected(co2_v2, TF_CO2_V2_FUNCTION_SET_CO2_CONCENTRATION_CALLBACK_CONFIGURATION, &_response_expected);
    tf_tfp_prepare_send(co2_v2->tfp, TF_CO2_V2_FUNCTION_SET_CO2_CONCENTRATION_CALLBACK_CONFIGURATION, 10, _response_expected);
...
int tf_co2_v2_get_co2_concentration_callback_configuration(TF_CO2V2 *co2_v2, uint32_t *ret_period, bool *ret_value_has_to_change, char *ret_option, uint16_t *ret_min, uint16_t *ret_max) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(co2_v2->tfp, TF_CO2_V2_FUNCTION_GET_CO2_CONCENTRATION_CALLBACK_CONFIGURATION, 0, _response_expected);
...
int tf_co2_v2_get_temperature(TF_CO2V2 *co2_v2, int16_t *ret_temperature) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(co2_v2->tfp, TF_CO2_V2_FUNCTION_GET_TEMPERATURE, 0, _response_expected);
...
int tf_co2_v2_set_temperature_callback_configuration(TF_CO2V2 *co2_v2, uint32_t period, bool value_has_to_change, char option, int16_t min, int16_t max) {
    ...
    bool _response_expected = true;
    tf_co2_v2_get_response_expected(co2_v2, TF_CO2_V2_FUNCTION_SET_TEMPERATURE_CALLBACK_CONFIGURATION, &_response_expected);
    tf_tfp_prepare_send(co2_v2->tfp, TF_CO2_V2_FUNCTION_SET_TEMPERATURE_CALLBACK_CONFIGURATION, 10, _response_expected);
...
int tf_co2_v2_get_temperature_callback_configuration(TF_CO2V2 *co2_v2, uint32_t *ret_period, bool *ret_value_has_to_change, char *ret_option, int16_t *ret_min, int16_t *ret_max) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(co2_v2->tfp, TF_CO2_V2_FUNCTION_GET_TEMPERATURE_CALLBACK_CONFIGURATION, 0, _response_expected);
...
int tf_co2_v2_get_humidity(TF_CO2V2 *co2_v2, uint16_t *ret_humidity) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(co2_v2->tfp, TF_CO2_V2_FUNCTION_GET_HUMIDITY, 0, _response_expected);
...
int tf_co2_v2_set_humidity_callback_configuration(TF_CO2V2 *co2_v2, uint32_t period, bool value_has_to_change, char option, uint16_t min, uint16_t max) {
    ...
    bool _response_expected = true;
    tf_co2_v2_get_response_expected(co2_v2, TF_CO2_V2_FUNCTION_SET_HUMIDITY_CALLBACK_CONFIGURATION, &_response_expected);
    tf_tfp_prepare_send(co2_v2->tfp, TF_CO2_V2_FUNCTION_SET_HUMIDITY_CALLBACK_CONFIGURATION, 10, _response_expected);
...
int tf_co2_v2_get_humidity_callback_configuration(TF_CO2V2 *co2_v2, uint32_t *ret_period, bool *ret_value_has_to_change, char *ret_option, uint16_t *ret_min, uint16_t *ret_max) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(co2_v2->tfp, TF_CO2_V2_FUNCTION_GET_HUMIDITY_CALLBACK_CONFIGURATION, 0, _response_expected);
...
int tf_co2_v2_get_spitfp_error_count(TF_CO2V2 *co2_v2, uint32_t *ret_error_count_ack_checksum, uint32_t *ret_error_count_message_checksum, uint32_t *ret_error_count_frame, uint32_t *ret_error_count_overflow) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(co2_v2->tfp, TF_CO2_V2_FUNCTION_GET_SPITFP_ERROR_COUNT, 0, _response_expected);
...
int tf_co2_v2_set_bootloader_mode(TF_CO2V2 *co2_v2, uint8_t mode, uint8_t *ret_status) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(co2_v2->tfp, TF_CO2_V2_FUNCTION_SET_BOOTLOADER_MODE, 1, _response_expected);
...
int tf_co2_v2_get_bootloader_mode(TF_CO2V2 *co2_v2, uint8_t *ret_mode) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(co2_v2->tfp, TF_CO2_V2_FUNCTION_GET_BOOTLOADER_MODE, 0, _response_expected);
...
int tf_co2_v2_set_write_firmware_pointer(TF_CO2V2 *co2_v2, uint32_t pointer) {
    ...
    bool _response_expected = true;
    tf_co2_v2_get_response_expected(co2_v2, TF_CO2_V2_FUNCTION_SET_WRITE_FIRMWARE_POINTER, &_response_expected);
    tf_tfp_prepare_send(co2_v2->tfp, TF_CO2_V2_FUNCTION_SET_WRITE_FIRMWARE_POINTER, 4, _response_expected);
...
int tf_co2_v2_write_firmware(TF_CO2V2 *co2_v2, const uint8_t data[64], uint8_t *ret_status) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(co2_v2->tfp, TF_CO2_V2_FUNCTION_WRITE_FIRMWARE, 64, _response_expected);
...
int tf_co2_v2_set_status_led_config(TF_CO2V2 *co2_v2, uint8_t config) {
    ...
    bool _response_expected = true;
    tf_co2_v2_get_response_expected(co2_v2, TF_CO2_V2_FUNCTION_SET_STATUS_LED_CONFIG, &_response_expected);
    tf_tfp_prepare_send(co2_v2->tfp, TF_CO2_V2_FUNCTION_SET_STATUS_LED_CONFIG, 1, _response_expected);
...
int tf_co2_v2_get_status_led_config(TF_CO2V2 *co2_v2, uint8_t *ret_config) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(co2_v2->tfp, TF_CO2_V2_FUNCTION_GET_STATUS_LED_CONFIG, 0, _response_expected);
...
int tf_co2_v2_get_chip_temperature(TF_CO2V2 *co2_v2, int16_t *ret_temperature) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(co2_v2->tfp, TF_CO2_V2_FUNCTION_GET_CHIP_TEMPERATURE, 0, _response_expected);
...
int tf_co2_v2_reset(TF_CO2V2 *co2_v2) {
    ...
    bool _response_expected = true;
    tf_co2_v2_get_response_expected(co2_v2, TF_CO2_V2_FUNCTION_RESET, &_response_expected);
    tf_tfp_prepare_send(co2_v2->tfp, TF_CO2_V2_FUNCTION_RESET, 0, _response_expected);
...
int tf_co2_v2_write_uid(TF_CO2V2 *co2_v2, uint32_t uid) {
    ...
    bool _response_expected = true;
    tf_co2_v2_get_response_expected(co2_v2, TF_CO2_V2_FUNCTION_WRITE_UID, &_response_expected);
    tf_tfp_prepare_send(co2_v2->tfp, TF_CO2_V2_FUNCTION_WRITE_UID, 4, _response_expected);
...
int tf_co2_v2_read_uid(TF_CO2V2 *co2_v2, uint32_t *ret_uid) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(co2_v2->tfp, TF_CO2_V2_FUNCTION_READ_UID, 0, _response_expected);
...
int tf_co2_v2_get_identity(TF_CO2V2 *co2_v2, char ret_uid[8], char ret_connected_uid[8], char *ret_position, uint8_t ret_hardware_version[3], uint8_t ret_firmware_version[3], uint16_t *ret_device_identifier) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(co2_v2->tfp, TF_CO2_V2_FUNCTION_GET_IDENTITY, 0, _response_expected);
