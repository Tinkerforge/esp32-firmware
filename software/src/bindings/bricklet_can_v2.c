...
int tf_can_v2_create(TF_CANV2 *can_v2, const char *uid, TF_HAL *hal) {
    if (can_v2 == NULL || uid == NULL || hal == NULL) {
        return TF_E_NULL;
    }
...
int tf_can_v2_write_frame_low_level(TF_CANV2 *can_v2, uint8_t frame_type, uint32_t identifier, uint8_t data_length, const uint8_t data_data[15], bool *ret_success) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_success != NULL) { *ret_success = tf_packet_buffer_read_bool(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 1); }
...
int tf_can_v2_read_frame_low_level(TF_CANV2 *can_v2, bool *ret_success, uint8_t *ret_frame_type, uint32_t *ret_identifier, uint8_t *ret_data_length, uint8_t ret_data_data[15]) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_success != NULL) { *ret_success = tf_packet_buffer_read_bool(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 1); }
        if (ret_frame_type != NULL) { *ret_frame_type = tf_packet_buffer_read_uint8_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 1); }
        if (ret_identifier != NULL) { *ret_identifier = tf_packet_buffer_read_uint32_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 4); }
        if (ret_data_length != NULL) { *ret_data_length = tf_packet_buffer_read_uint8_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 1); }
        if (ret_data_data != NULL) { for (i = 0; i < 15; ++i) ret_data_data[i] = tf_packet_buffer_read_uint8_t(&can_v2->tfp->spitfp->recv_buf);} else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 15); }
        tf_tfp_packet_processed(can_v2->tfp);
    }
...
int tf_can_v2_get_frame_read_callback_configuration(TF_CANV2 *can_v2, bool *ret_enabled) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_enabled != NULL) { *ret_enabled = tf_packet_buffer_read_bool(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 1); }
        tf_tfp_packet_processed(can_v2->tfp);
    }
...
int tf_can_v2_get_transceiver_configuration(TF_CANV2 *can_v2, uint32_t *ret_baud_rate, uint16_t *ret_sample_point, uint8_t *ret_transceiver_mode) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_baud_rate != NULL) { *ret_baud_rate = tf_packet_buffer_read_uint32_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 4); }
        if (ret_sample_point != NULL) { *ret_sample_point = tf_packet_buffer_read_uint16_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 2); }
        if (ret_transceiver_mode != NULL) { *ret_transceiver_mode = tf_packet_buffer_read_uint8_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 1); }
        tf_tfp_packet_processed(can_v2->tfp);
    }
...
int tf_can_v2_get_queue_configuration_low_level(TF_CANV2 *can_v2, uint8_t *ret_write_buffer_size, int32_t *ret_write_buffer_timeout, uint16_t *ret_write_backlog_size, uint8_t *ret_read_buffer_sizes_length, int8_t ret_read_buffer_sizes_data[32], uint16_t *ret_read_backlog_size) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_write_buffer_size != NULL) { *ret_write_buffer_size = tf_packet_buffer_read_uint8_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 1); }
        if (ret_write_buffer_timeout != NULL) { *ret_write_buffer_timeout = tf_packet_buffer_read_int32_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 4); }
        if (ret_write_backlog_size != NULL) { *ret_write_backlog_size = tf_packet_buffer_read_uint16_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 2); }
        if (ret_read_buffer_sizes_length != NULL) { *ret_read_buffer_sizes_length = tf_packet_buffer_read_uint8_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 1); }
        if (ret_read_buffer_sizes_data != NULL) { for (i = 0; i < 32; ++i) ret_read_buffer_sizes_data[i] = tf_packet_buffer_read_int8_t(&can_v2->tfp->spitfp->recv_buf);} else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 32); }
        if (ret_read_backlog_size != NULL) { *ret_read_backlog_size = tf_packet_buffer_read_uint16_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 2); }
        tf_tfp_packet_processed(can_v2->tfp);
    }
...
int tf_can_v2_get_read_filter_configuration(TF_CANV2 *can_v2, uint8_t buffer_index, uint8_t *ret_filter_mode, uint32_t *ret_filter_mask, uint32_t *ret_filter_identifier) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_filter_mode != NULL) { *ret_filter_mode = tf_packet_buffer_read_uint8_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 1); }
        if (ret_filter_mask != NULL) { *ret_filter_mask = tf_packet_buffer_read_uint32_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 4); }
        if (ret_filter_identifier != NULL) { *ret_filter_identifier = tf_packet_buffer_read_uint32_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 4); }
        tf_tfp_packet_processed(can_v2->tfp);
    }
...
int tf_can_v2_get_error_log_low_level(TF_CANV2 *can_v2, uint8_t *ret_transceiver_state, uint8_t *ret_transceiver_write_error_level, uint8_t *ret_transceiver_read_error_level, uint32_t *ret_transceiver_stuffing_error_count, uint32_t *ret_transceiver_format_error_count, uint32_t *ret_transceiver_ack_error_count, uint32_t *ret_transceiver_bit1_error_count, uint32_t *ret_transceiver_bit0_error_count, uint32_t *ret_transceiver_crc_error_count, uint32_t *ret_write_buffer_timeout_error_count, uint32_t *ret_read_buffer_overflow_error_count, uint8_t *ret_read_buffer_overflow_error_occurred_length, bool ret_read_buffer_overflow_error_occurred_data[32], uint32_t *ret_read_backlog_overflow_error_count) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_transceiver_state != NULL) { *ret_transceiver_state = tf_packet_buffer_read_uint8_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 1); }
        if (ret_transceiver_write_error_level != NULL) { *ret_transceiver_write_error_level = tf_packet_buffer_read_uint8_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 1); }
        if (ret_transceiver_read_error_level != NULL) { *ret_transceiver_read_error_level = tf_packet_buffer_read_uint8_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 1); }
        if (ret_transceiver_stuffing_error_count != NULL) { *ret_transceiver_stuffing_error_count = tf_packet_buffer_read_uint32_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 4); }
        if (ret_transceiver_format_error_count != NULL) { *ret_transceiver_format_error_count = tf_packet_buffer_read_uint32_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 4); }
        if (ret_transceiver_ack_error_count != NULL) { *ret_transceiver_ack_error_count = tf_packet_buffer_read_uint32_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 4); }
        if (ret_transceiver_bit1_error_count != NULL) { *ret_transceiver_bit1_error_count = tf_packet_buffer_read_uint32_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 4); }
        if (ret_transceiver_bit0_error_count != NULL) { *ret_transceiver_bit0_error_count = tf_packet_buffer_read_uint32_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 4); }
        if (ret_transceiver_crc_error_count != NULL) { *ret_transceiver_crc_error_count = tf_packet_buffer_read_uint32_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 4); }
        if (ret_write_buffer_timeout_error_count != NULL) { *ret_write_buffer_timeout_error_count = tf_packet_buffer_read_uint32_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 4); }
        if (ret_read_buffer_overflow_error_count != NULL) { *ret_read_buffer_overflow_error_count = tf_packet_buffer_read_uint32_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 4); }
        if (ret_read_buffer_overflow_error_occurred_length != NULL) { *ret_read_buffer_overflow_error_occurred_length = tf_packet_buffer_read_uint8_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 1); }
        if (ret_read_buffer_overflow_error_occurred_data != NULL) { tf_packet_buffer_read_bool_array(&can_v2->tfp->spitfp->recv_buf, ret_read_buffer_overflow_error_occurred_data, 32);} else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 4); }
        if (ret_read_backlog_overflow_error_count != NULL) { *ret_read_backlog_overflow_error_count = tf_packet_buffer_read_uint32_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 4); }
        tf_tfp_packet_processed(can_v2->tfp);
    }
...
int tf_can_v2_get_communication_led_config(TF_CANV2 *can_v2, uint8_t *ret_config) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_config != NULL) { *ret_config = tf_packet_buffer_read_uint8_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 1); }
        tf_tfp_packet_processed(can_v2->tfp);
    }
...
int tf_can_v2_get_spitfp_error_count(TF_CANV2 *can_v2, uint32_t *ret_error_count_ack_checksum, uint32_t *ret_error_count_message_checksum, uint32_t *ret_error_count_frame, uint32_t *ret_error_count_overflow) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_error_count_ack_checksum != NULL) { *ret_error_count_ack_checksum = tf_packet_buffer_read_uint32_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 4); }
        if (ret_error_count_message_checksum != NULL) { *ret_error_count_message_checksum = tf_packet_buffer_read_uint32_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 4); }
        if (ret_error_count_frame != NULL) { *ret_error_count_frame = tf_packet_buffer_read_uint32_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 4); }
        if (ret_error_count_overflow != NULL) { *ret_error_count_overflow = tf_packet_buffer_read_uint32_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 4); }
        tf_tfp_packet_processed(can_v2->tfp);
    }
...
int tf_can_v2_set_bootloader_mode(TF_CANV2 *can_v2, uint8_t mode, uint8_t *ret_status) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_status != NULL) { *ret_status = tf_packet_buffer_read_uint8_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 1); }
        tf_tfp_packet_processed(can_v2->tfp);
    }
...
int tf_can_v2_get_bootloader_mode(TF_CANV2 *can_v2, uint8_t *ret_mode) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_mode != NULL) { *ret_mode = tf_packet_buffer_read_uint8_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 1); }
        tf_tfp_packet_processed(can_v2->tfp);
    }
...
int tf_can_v2_get_chip_temperature(TF_CANV2 *can_v2, int16_t *ret_temperature) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_temperature != NULL) { *ret_temperature = tf_packet_buffer_read_int16_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 2); }
        tf_tfp_packet_processed(can_v2->tfp);
    }
...
int tf_can_v2_read_uid(TF_CANV2 *can_v2, uint32_t *ret_uid) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_uid != NULL) { *ret_uid = tf_packet_buffer_read_uint32_t(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 4); }
        tf_tfp_packet_processed(can_v2->tfp);
    }
...
int tf_can_v2_get_identity(TF_CANV2 *can_v2, char ret_uid[8], char ret_connected_uid[8], char *ret_position, uint8_t ret_hardware_version[3], uint8_t ret_firmware_version[3], uint16_t *ret_device_identifier) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        ...
        if (ret_uid != NULL) { tf_packet_buffer_pop_n(&can_v2->tfp->spitfp->recv_buf, (uint8_t*)ret_uid, 8);} else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 8); }
        tf_packet_buffer_pop_n(&can_v2->tfp->spitfp->recv_buf, (uint8_t*)tmp_connected_uid, 8);
        if (ret_position != NULL) { *ret_position = tf_packet_buffer_read_char(&can_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 1); }
        if (ret_hardware_version != NULL) { for (i = 0; i < 3; ++i) ret_hardware_version[i] = tf_packet_buffer_read_uint8_t(&can_v2->tfp->spitfp->recv_buf);} else { tf_packet_buffer_remove(&can_v2->tfp->spitfp->recv_buf, 3); }
