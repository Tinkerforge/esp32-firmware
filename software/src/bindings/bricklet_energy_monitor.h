...
#ifndef TF_ENERGY_MONITOR_H
#define TF_ENERGY_MONITOR_H
...
/**
 * \defgroup TF_EnergyMonitor Energy Monitor Bricklet
 */
 ...
 * \ingroup TF_EnergyMonitor
 *
 * Removes the device object \c energy_monitor from its HAL and destroys it.
 ...
 * via the tf_energy_monitor_set_response_expected function. For setter
