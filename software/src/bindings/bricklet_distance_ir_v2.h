...
#ifndef TF_DISTANCE_IR_V2_H
#define TF_DISTANCE_IR_V2_H
...
/**
 * \defgroup TF_DistanceIRV2 Distance IR Bricklet 2.0
 */
 ...
 * \ingroup TF_DistanceIRV2
 *
 * Removes the device object \c distance_ir_v2 from its HAL and destroys it.
 ...
 * via the tf_distance_ir_v2_set_response_expected function. For setter
