...
static bool tf_industrial_dual_relay_callback_handler(void *device, uint8_t fid, TF_PacketBuffer *payload) {
    TF_IndustrialDualRelay *industrial_dual_relay = (TF_IndustrialDualRelay *)device;
    TF_HALCommon *hal_common = tf_hal_get_common(industrial_dual_relay->tfp->spitfp->hal);
    (void)payload;
...
int tf_industrial_dual_relay_create(TF_IndustrialDualRelay *industrial_dual_relay, const char *uid_or_port_name, TF_HAL *hal) {
    if (industrial_dual_relay == NULL || hal == NULL) {
        return TF_E_NULL;
    }
    ...
    TF_TFP *tfp;
    int rc = tf_hal_get_attachable_tfp(hal, &tfp, uid_or_port_name, TF_INDUSTRIAL_DUAL_RELAY_DEVICE_IDENTIFIER);

    if (rc != TF_E_OK) {
        return rc;
    }

    industrial_dual_relay->tfp = tfp;
    ...
    industrial_dual_relay->magic = 0x5446;
...
int tf_industrial_dual_relay_destroy(TF_IndustrialDualRelay *industrial_dual_relay) {
    ...
    industrial_dual_relay->tfp->cb_handler = NULL;
    industrial_dual_relay->tfp->device = NULL;
    industrial_dual_relay->tfp = NULL;
    industrial_dual_relay->magic = 0;
...
int tf_industrial_dual_relay_set_value(TF_IndustrialDualRelay *industrial_dual_relay, bool channel0, bool channel1) {
    ...
    tf_industrial_dual_relay_get_response_expected(industrial_dual_relay, TF_INDUSTRIAL_DUAL_RELAY_FUNCTION_SET_VALUE, &_response_expected);
    tf_tfp_prepare_send(industrial_dual_relay->tfp, TF_INDUSTRIAL_DUAL_RELAY_FUNCTION_SET_VALUE, 2, _response_expected);
    ...
    uint8_t _length = 0;
    int _result = tf_tfp_send_packet(industrial_dual_relay->tfp, _response_expected, _deadline, &_error_code, &_length, TF_NEW_PACKET);
...
int tf_industrial_dual_relay_get_value(TF_IndustrialDualRelay *industrial_dual_relay, bool *ret_channel0, bool *ret_channel1) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(industrial_dual_relay->tfp, TF_INDUSTRIAL_DUAL_RELAY_FUNCTION_GET_VALUE, 0, _response_expected);
    ...
    if (_result & TF_TICK_PACKET_RECEIVED) {
        TF_PacketBuffer *_recv_buf = tf_tfp_get_receive_buffer(industrial_dual_relay->tfp);
...
int tf_industrial_dual_relay_set_monoflop(TF_IndustrialDualRelay *industrial_dual_relay, uint8_t channel, bool value, uint32_t time) {
    ...
    bool _response_expected = true;
    tf_industrial_dual_relay_get_response_expected(industrial_dual_relay, TF_INDUSTRIAL_DUAL_RELAY_FUNCTION_SET_MONOFLOP, &_response_expected);
    tf_tfp_prepare_send(industrial_dual_relay->tfp, TF_INDUSTRIAL_DUAL_RELAY_FUNCTION_SET_MONOFLOP, 6, _response_expected);
...
int tf_industrial_dual_relay_get_monoflop(TF_IndustrialDualRelay *industrial_dual_relay, uint8_t channel, bool *ret_value, uint32_t *ret_time, uint32_t *ret_time_remaining) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(industrial_dual_relay->tfp, TF_INDUSTRIAL_DUAL_RELAY_FUNCTION_GET_MONOFLOP, 1, _response_expected);
...
int tf_industrial_dual_relay_set_selected_value(TF_IndustrialDualRelay *industrial_dual_relay, uint8_t channel, bool value) {
    ...
    bool _response_expected = true;
    tf_industrial_dual_relay_get_response_expected(industrial_dual_relay, TF_INDUSTRIAL_DUAL_RELAY_FUNCTION_SET_SELECTED_VALUE, &_response_expected);
    tf_tfp_prepare_send(industrial_dual_relay->tfp, TF_INDUSTRIAL_DUAL_RELAY_FUNCTION_SET_SELECTED_VALUE, 2, _response_expected);
...
int tf_industrial_dual_relay_get_spitfp_error_count(TF_IndustrialDualRelay *industrial_dual_relay, uint32_t *ret_error_count_ack_checksum, uint32_t *ret_error_count_message_checksum, uint32_t *ret_error_count_frame, uint32_t *ret_error_count_overflow) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(industrial_dual_relay->tfp, TF_INDUSTRIAL_DUAL_RELAY_FUNCTION_GET_SPITFP_ERROR_COUNT, 0, _response_expected);
...
int tf_industrial_dual_relay_set_bootloader_mode(TF_IndustrialDualRelay *industrial_dual_relay, uint8_t mode, uint8_t *ret_status) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(industrial_dual_relay->tfp, TF_INDUSTRIAL_DUAL_RELAY_FUNCTION_SET_BOOTLOADER_MODE, 1, _response_expected);
...
int tf_industrial_dual_relay_get_bootloader_mode(TF_IndustrialDualRelay *industrial_dual_relay, uint8_t *ret_mode) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(industrial_dual_relay->tfp, TF_INDUSTRIAL_DUAL_RELAY_FUNCTION_GET_BOOTLOADER_MODE, 0, _response_expected);
...
int tf_industrial_dual_relay_set_write_firmware_pointer(TF_IndustrialDualRelay *industrial_dual_relay, uint32_t pointer) {
    ...
    bool _response_expected = true;
    tf_industrial_dual_relay_get_response_expected(industrial_dual_relay, TF_INDUSTRIAL_DUAL_RELAY_FUNCTION_SET_WRITE_FIRMWARE_POINTER, &_response_expected);
    tf_tfp_prepare_send(industrial_dual_relay->tfp, TF_INDUSTRIAL_DUAL_RELAY_FUNCTION_SET_WRITE_FIRMWARE_POINTER, 4, _response_expected);
...
int tf_industrial_dual_relay_write_firmware(TF_IndustrialDualRelay *industrial_dual_relay, const uint8_t data[64], uint8_t *ret_status) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(industrial_dual_relay->tfp, TF_INDUSTRIAL_DUAL_RELAY_FUNCTION_WRITE_FIRMWARE, 64, _response_expected);
...
int tf_industrial_dual_relay_set_status_led_config(TF_IndustrialDualRelay *industrial_dual_relay, uint8_t config) {
    ...
    bool _response_expected = true;
    tf_industrial_dual_relay_get_response_expected(industrial_dual_relay, TF_INDUSTRIAL_DUAL_RELAY_FUNCTION_SET_STATUS_LED_CONFIG, &_response_expected);
    tf_tfp_prepare_send(industrial_dual_relay->tfp, TF_INDUSTRIAL_DUAL_RELAY_FUNCTION_SET_STATUS_LED_CONFIG, 1, _response_expected);
...
int tf_industrial_dual_relay_get_status_led_config(TF_IndustrialDualRelay *industrial_dual_relay, uint8_t *ret_config) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(industrial_dual_relay->tfp, TF_INDUSTRIAL_DUAL_RELAY_FUNCTION_GET_STATUS_LED_CONFIG, 0, _response_expected);
...
int tf_industrial_dual_relay_get_chip_temperature(TF_IndustrialDualRelay *industrial_dual_relay, int16_t *ret_temperature) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(industrial_dual_relay->tfp, TF_INDUSTRIAL_DUAL_RELAY_FUNCTION_GET_CHIP_TEMPERATURE, 0, _response_expected);
...
int tf_industrial_dual_relay_reset(TF_IndustrialDualRelay *industrial_dual_relay) {
    ...
    bool _response_expected = true;
    tf_industrial_dual_relay_get_response_expected(industrial_dual_relay, TF_INDUSTRIAL_DUAL_RELAY_FUNCTION_RESET, &_response_expected);
    tf_tfp_prepare_send(industrial_dual_relay->tfp, TF_INDUSTRIAL_DUAL_RELAY_FUNCTION_RESET, 0, _response_expected);
...
int tf_industrial_dual_relay_write_uid(TF_IndustrialDualRelay *industrial_dual_relay, uint32_t uid) {
    ...
    bool _response_expected = true;
    tf_industrial_dual_relay_get_response_expected(industrial_dual_relay, TF_INDUSTRIAL_DUAL_RELAY_FUNCTION_WRITE_UID, &_response_expected);
    tf_tfp_prepare_send(industrial_dual_relay->tfp, TF_INDUSTRIAL_DUAL_RELAY_FUNCTION_WRITE_UID, 4, _response_expected);
...
int tf_industrial_dual_relay_read_uid(TF_IndustrialDualRelay *industrial_dual_relay, uint32_t *ret_uid) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(industrial_dual_relay->tfp, TF_INDUSTRIAL_DUAL_RELAY_FUNCTION_READ_UID, 0, _response_expected);
...
int tf_industrial_dual_relay_get_identity(TF_IndustrialDualRelay *industrial_dual_relay, char ret_uid[8], char ret_connected_uid[8], char *ret_position, uint8_t ret_hardware_version[3], uint8_t ret_firmware_version[3], uint16_t *ret_device_identifier) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(industrial_dual_relay->tfp, TF_INDUSTRIAL_DUAL_RELAY_FUNCTION_GET_IDENTITY, 0, _response_expected);
...
int tf_industrial_dual_relay_callback_tick(TF_IndustrialDualRelay *industrial_dual_relay, uint32_t timeout_us) {
    ...
    TF_HAL *hal = industrial_dual_relay->tfp->spitfp->hal;

    return tf_tfp_callback_tick(industrial_dual_relay->tfp, tf_hal_current_time_us(hal) + timeout_us);
}
