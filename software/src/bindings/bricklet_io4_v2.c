...
static bool tf_io4_v2_callback_handler(void *device, uint8_t fid, TF_PacketBuffer *payload) {
    TF_IO4V2 *io4_v2 = (TF_IO4V2 *)device;
    TF_HALCommon *hal_common = tf_hal_get_common(io4_v2->tfp->spitfp->hal);
    (void)payload;
...
#endif
int tf_io4_v2_create(TF_IO4V2 *io4_v2, const char *uid_or_port_name, TF_HAL *hal) {
    if (io4_v2 == NULL || hal == NULL) {
        return TF_E_NULL;
    }
    ...
    TF_TFP *tfp;
    int rc = tf_hal_get_attachable_tfp(hal, &tfp, uid_or_port_name, TF_IO4_V2_DEVICE_IDENTIFIER);
...
int tf_io4_v2_set_value(TF_IO4V2 *io4_v2, const bool value[4]) {
    ...
    tf_io4_v2_get_response_expected(io4_v2, TF_IO4_V2_FUNCTION_SET_VALUE, &_response_expected);
    tf_tfp_prepare_send(io4_v2->tfp, TF_IO4_V2_FUNCTION_SET_VALUE, 1, _response_expected);
    ...
    uint8_t _length = 0;
    int _result = tf_tfp_send_packet(io4_v2->tfp, _response_expected, _deadline, &_error_code, &_length);
...
int tf_io4_v2_get_value(TF_IO4V2 *io4_v2, bool ret_value[4]) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(io4_v2->tfp, TF_IO4_V2_FUNCTION_GET_VALUE, 0, _response_expected);
...
int tf_io4_v2_set_selected_value(TF_IO4V2 *io4_v2, uint8_t channel, bool value) {
    ...
    bool _response_expected = true;
    tf_io4_v2_get_response_expected(io4_v2, TF_IO4_V2_FUNCTION_SET_SELECTED_VALUE, &_response_expected);
    tf_tfp_prepare_send(io4_v2->tfp, TF_IO4_V2_FUNCTION_SET_SELECTED_VALUE, 2, _response_expected);
...
int tf_io4_v2_set_configuration(TF_IO4V2 *io4_v2, uint8_t channel, char direction, bool value) {
    ...
    bool _response_expected = true;
    tf_io4_v2_get_response_expected(io4_v2, TF_IO4_V2_FUNCTION_SET_CONFIGURATION, &_response_expected);
    tf_tfp_prepare_send(io4_v2->tfp, TF_IO4_V2_FUNCTION_SET_CONFIGURATION, 3, _response_expected);
...
int tf_io4_v2_get_configuration(TF_IO4V2 *io4_v2, uint8_t channel, char *ret_direction, bool *ret_value) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(io4_v2->tfp, TF_IO4_V2_FUNCTION_GET_CONFIGURATION, 1, _response_expected);
...
int tf_io4_v2_set_input_value_callback_configuration(TF_IO4V2 *io4_v2, uint8_t channel, uint32_t period, bool value_has_to_change) {
    ...
    bool _response_expected = true;
    tf_io4_v2_get_response_expected(io4_v2, TF_IO4_V2_FUNCTION_SET_INPUT_VALUE_CALLBACK_CONFIGURATION, &_response_expected);
    tf_tfp_prepare_send(io4_v2->tfp, TF_IO4_V2_FUNCTION_SET_INPUT_VALUE_CALLBACK_CONFIGURATION, 6, _response_expected);
...
int tf_io4_v2_get_input_value_callback_configuration(TF_IO4V2 *io4_v2, uint8_t channel, uint32_t *ret_period, bool *ret_value_has_to_change) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(io4_v2->tfp, TF_IO4_V2_FUNCTION_GET_INPUT_VALUE_CALLBACK_CONFIGURATION, 1, _response_expected);
...
int tf_io4_v2_set_all_input_value_callback_configuration(TF_IO4V2 *io4_v2, uint32_t period, bool value_has_to_change) {
    ...
    bool _response_expected = true;
    tf_io4_v2_get_response_expected(io4_v2, TF_IO4_V2_FUNCTION_SET_ALL_INPUT_VALUE_CALLBACK_CONFIGURATION, &_response_expected);
    tf_tfp_prepare_send(io4_v2->tfp, TF_IO4_V2_FUNCTION_SET_ALL_INPUT_VALUE_CALLBACK_CONFIGURATION, 5, _response_expected);
...
int tf_io4_v2_get_all_input_value_callback_configuration(TF_IO4V2 *io4_v2, uint32_t *ret_period, bool *ret_value_has_to_change) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(io4_v2->tfp, TF_IO4_V2_FUNCTION_GET_ALL_INPUT_VALUE_CALLBACK_CONFIGURATION, 0, _response_expected);
...
int tf_io4_v2_set_monoflop(TF_IO4V2 *io4_v2, uint8_t channel, bool value, uint32_t time) {
    ...
    bool _response_expected = true;
    tf_io4_v2_get_response_expected(io4_v2, TF_IO4_V2_FUNCTION_SET_MONOFLOP, &_response_expected);
    tf_tfp_prepare_send(io4_v2->tfp, TF_IO4_V2_FUNCTION_SET_MONOFLOP, 6, _response_expected);
...
int tf_io4_v2_get_monoflop(TF_IO4V2 *io4_v2, uint8_t channel, bool *ret_value, uint32_t *ret_time, uint32_t *ret_time_remaining) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(io4_v2->tfp, TF_IO4_V2_FUNCTION_GET_MONOFLOP, 1, _response_expected);
...
int tf_io4_v2_get_edge_count(TF_IO4V2 *io4_v2, uint8_t channel, bool reset_counter, uint32_t *ret_count) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(io4_v2->tfp, TF_IO4_V2_FUNCTION_GET_EDGE_COUNT, 2, _response_expected);
...
int tf_io4_v2_set_edge_count_configuration(TF_IO4V2 *io4_v2, uint8_t channel, uint8_t edge_type, uint8_t debounce) {
    ...
    bool _response_expected = true;
    tf_io4_v2_get_response_expected(io4_v2, TF_IO4_V2_FUNCTION_SET_EDGE_COUNT_CONFIGURATION, &_response_expected);
    tf_tfp_prepare_send(io4_v2->tfp, TF_IO4_V2_FUNCTION_SET_EDGE_COUNT_CONFIGURATION, 3, _response_expected);
...
int tf_io4_v2_get_edge_count_configuration(TF_IO4V2 *io4_v2, uint8_t channel, uint8_t *ret_edge_type, uint8_t *ret_debounce) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(io4_v2->tfp, TF_IO4_V2_FUNCTION_GET_EDGE_COUNT_CONFIGURATION, 1, _response_expected);
...
int tf_io4_v2_set_pwm_configuration(TF_IO4V2 *io4_v2, uint8_t channel, uint32_t frequency, uint16_t duty_cycle) {
    ...
    bool _response_expected = true;
    tf_io4_v2_get_response_expected(io4_v2, TF_IO4_V2_FUNCTION_SET_PWM_CONFIGURATION, &_response_expected);
    tf_tfp_prepare_send(io4_v2->tfp, TF_IO4_V2_FUNCTION_SET_PWM_CONFIGURATION, 7, _response_expected);
...
int tf_io4_v2_get_pwm_configuration(TF_IO4V2 *io4_v2, uint8_t channel, uint32_t *ret_frequency, uint16_t *ret_duty_cycle) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(io4_v2->tfp, TF_IO4_V2_FUNCTION_GET_PWM_CONFIGURATION, 1, _response_expected);
...
int tf_io4_v2_get_spitfp_error_count(TF_IO4V2 *io4_v2, uint32_t *ret_error_count_ack_checksum, uint32_t *ret_error_count_message_checksum, uint32_t *ret_error_count_frame, uint32_t *ret_error_count_overflow) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(io4_v2->tfp, TF_IO4_V2_FUNCTION_GET_SPITFP_ERROR_COUNT, 0, _response_expected);
...
int tf_io4_v2_set_bootloader_mode(TF_IO4V2 *io4_v2, uint8_t mode, uint8_t *ret_status) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(io4_v2->tfp, TF_IO4_V2_FUNCTION_SET_BOOTLOADER_MODE, 1, _response_expected);
...
int tf_io4_v2_get_bootloader_mode(TF_IO4V2 *io4_v2, uint8_t *ret_mode) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(io4_v2->tfp, TF_IO4_V2_FUNCTION_GET_BOOTLOADER_MODE, 0, _response_expected);
...
int tf_io4_v2_set_write_firmware_pointer(TF_IO4V2 *io4_v2, uint32_t pointer) {
    ...
    bool _response_expected = true;
    tf_io4_v2_get_response_expected(io4_v2, TF_IO4_V2_FUNCTION_SET_WRITE_FIRMWARE_POINTER, &_response_expected);
    tf_tfp_prepare_send(io4_v2->tfp, TF_IO4_V2_FUNCTION_SET_WRITE_FIRMWARE_POINTER, 4, _response_expected);
...
int tf_io4_v2_write_firmware(TF_IO4V2 *io4_v2, const uint8_t data[64], uint8_t *ret_status) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(io4_v2->tfp, TF_IO4_V2_FUNCTION_WRITE_FIRMWARE, 64, _response_expected);
...
int tf_io4_v2_set_status_led_config(TF_IO4V2 *io4_v2, uint8_t config) {
    ...
    bool _response_expected = true;
    tf_io4_v2_get_response_expected(io4_v2, TF_IO4_V2_FUNCTION_SET_STATUS_LED_CONFIG, &_response_expected);
    tf_tfp_prepare_send(io4_v2->tfp, TF_IO4_V2_FUNCTION_SET_STATUS_LED_CONFIG, 1, _response_expected);
...
int tf_io4_v2_get_status_led_config(TF_IO4V2 *io4_v2, uint8_t *ret_config) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(io4_v2->tfp, TF_IO4_V2_FUNCTION_GET_STATUS_LED_CONFIG, 0, _response_expected);
...
int tf_io4_v2_get_chip_temperature(TF_IO4V2 *io4_v2, int16_t *ret_temperature) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(io4_v2->tfp, TF_IO4_V2_FUNCTION_GET_CHIP_TEMPERATURE, 0, _response_expected);
...
int tf_io4_v2_reset(TF_IO4V2 *io4_v2) {
    ...
    bool _response_expected = true;
    tf_io4_v2_get_response_expected(io4_v2, TF_IO4_V2_FUNCTION_RESET, &_response_expected);
    tf_tfp_prepare_send(io4_v2->tfp, TF_IO4_V2_FUNCTION_RESET, 0, _response_expected);
...
int tf_io4_v2_write_uid(TF_IO4V2 *io4_v2, uint32_t uid) {
    ...
    bool _response_expected = true;
    tf_io4_v2_get_response_expected(io4_v2, TF_IO4_V2_FUNCTION_WRITE_UID, &_response_expected);
    tf_tfp_prepare_send(io4_v2->tfp, TF_IO4_V2_FUNCTION_WRITE_UID, 4, _response_expected);
...
int tf_io4_v2_read_uid(TF_IO4V2 *io4_v2, uint32_t *ret_uid) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(io4_v2->tfp, TF_IO4_V2_FUNCTION_READ_UID, 0, _response_expected);
...
int tf_io4_v2_get_identity(TF_IO4V2 *io4_v2, char ret_uid[8], char ret_connected_uid[8], char *ret_position, uint8_t ret_hardware_version[3], uint8_t ret_firmware_version[3], uint16_t *ret_device_identifier) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(io4_v2->tfp, TF_IO4_V2_FUNCTION_GET_IDENTITY, 0, _response_expected);
...
int tf_io4_v2_callback_tick(TF_IO4V2 *io4_v2, uint32_t timeout_us) {
    ...
    return tf_tfp_callback_tick(io4_v2->tfp, tf_hal_current_time_us(hal) + timeout_us);
}
