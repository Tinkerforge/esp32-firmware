...
#ifndef TF_LASER_RANGE_FINDER_V2_H
#define TF_LASER_RANGE_FINDER_V2_H
...
/**
 * \defgroup TF_LaserRangeFinderV2 Laser Range Finder Bricklet 2.0
 */
 ...
 * \ingroup TF_LaserRangeFinderV2
 *
 * Removes the device object \c laser_range_finder_v2 from its HAL and destroys it.
 ...
 * via the tf_laser_range_finder_v2_set_response_expected function. For setter
