...
#ifndef TF_RGB_LED_V2_H
#define TF_RGB_LED_V2_H
...
/**
 * \defgroup TF_RGBLEDV2 RGB LED Bricklet 2.0
 */
 ...
 * \ingroup TF_RGBLEDV2
 *
 * Removes the device object \c rgb_led_v2 from its HAL and destroys it.
 ...
 * via the tf_rgb_led_v2_set_response_expected function. For setter
