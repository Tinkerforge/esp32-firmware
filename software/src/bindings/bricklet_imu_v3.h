...
/**
 * \defgroup TF_IMUV3 IMU Bricklet 3.0
 */
 ...
 * \ingroup TF_IMUV3
 *
 * Removes the device object \c imu_v3 from its HAL and destroys it.
 ...
 * via the tf_imu_v3_set_response_expected function. For setter
