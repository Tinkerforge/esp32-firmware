...
#ifndef TF_DUAL_BUTTON_V2_H
#define TF_DUAL_BUTTON_V2_H
...
/**
 * \defgroup TF_DualButtonV2 Dual Button Bricklet 2.0
 */
 ...
 * \ingroup TF_DualButtonV2
 *
 * Removes the device object \c dual_button_v2 from its HAL and destroys it.
 ...
 * via the tf_dual_button_v2_set_response_expected function. For setter
