...
#include <stddef.h>
    ...
    #define TF_ATTRIBUTE_NONNULL_ALL
...
#define TF_TFP_MIN_MESSAGE_LENGTH 8
#define TF_TFP_MAX_MESSAGE_LENGTH 80
...
#define TF_SPITFP_MIN_MESSAGE_LENGTH (TF_TFP_MIN_MESSAGE_LENGTH + TF_SPITFP_PROTOCOL_OVERHEAD)
#define TF_SPITFP_MAX_MESSAGE_LENGTH (TF_TFP_MAX_MESSAGE_LENGTH + TF_SPITFP_PROTOCOL_OVERHEAD)
