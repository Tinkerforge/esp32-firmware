...
#ifndef TF_REAL_TIME_CLOCK_V2_H
#define TF_REAL_TIME_CLOCK_V2_H
...
/**
 * \defgroup TF_RealTimeClockV2 Real-Time Clock Bricklet 2.0
 */
 ...
 * \ingroup TF_RealTimeClockV2
 *
 * Removes the device object \c real_time_clock_v2 from its HAL and destroys it.
 ...
 * via the tf_real_time_clock_v2_set_response_expected function. For setter
