...
#ifndef TF_ANALOG_IN_V3_H
#define TF_ANALOG_IN_V3_H
...
/**
 * \defgroup TF_AnalogInV3 Analog In Bricklet 3.0
 */
 ...
 * \ingroup TF_AnalogInV3
 *
 * Removes the device object \c analog_in_v3 from its HAL and destroys it.
 ...
 * via the tf_analog_in_v3_set_response_expected function. For setter
