...
#ifndef TF_ACCELEROMETER_V2_H
#define TF_ACCELEROMETER_V2_H
...
/**
 * \defgroup TF_AccelerometerV2 Accelerometer Bricklet 2.0
 */
 ...
 * \ingroup TF_AccelerometerV2
 *
 * Removes the device object \c accelerometer_v2 from its HAL and destroys it.
 ...
 * via the tf_accelerometer_v2_set_response_expected function. For setter
