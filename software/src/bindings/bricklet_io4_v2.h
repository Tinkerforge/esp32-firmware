...
typedef void (*TF_IO4V2MonoflopDoneHandler)(struct TF_IO4V2 *device, uint8_t channel, bool value, void *user_data);
...
typedef struct TF_IO4V2 {
    ...
    TF_IO4V2AllInputValueHandler all_input_value_handler;
    void *all_input_value_user_data;

    TF_IO4V2MonoflopDoneHandler monoflop_done_handler;
