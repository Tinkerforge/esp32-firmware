...
typedef void (*TF_IO16V2_InputValueHandler)(struct TF_IO16V2 *io16_v2, uint8_t channel, bool changed, bool value, void *user_data);
typedef void (*TF_IO16V2_AllInputValueHandler)(struct TF_IO16V2 *io16_v2, bool changed[16], bool value[16], void *user_data);
typedef void (*TF_IO16V2_MonoflopDoneHandler)(struct TF_IO16V2 *io16_v2, uint8_t channel, bool value, void *user_data);
