...
#ifndef TF_MULTI_TOUCH_V2_H
#define TF_MULTI_TOUCH_V2_H
...
/**
 * \defgroup TF_MultiTouchV2 Multi Touch Bricklet 2.0
 */
 ...
 * \ingroup TF_MultiTouchV2
 *
 * Removes the device object \c multi_touch_v2 from its HAL and destroys it.
 ...
 * via the tf_multi_touch_v2_set_response_expected function. For setter
