...
typedef void (*TF_VoltageCurrentV2_CurrentHandler)(struct TF_VoltageCurrentV2 *voltage_current_v2, int32_t current, void *user_data);
typedef void (*TF_VoltageCurrentV2_VoltageHandler)(struct TF_VoltageCurrentV2 *voltage_current_v2, int32_t voltage, void *user_data);
typedef void (*TF_VoltageCurrentV2_PowerHandler)(struct TF_VoltageCurrentV2 *voltage_current_v2, int32_t power, void *user_data);
