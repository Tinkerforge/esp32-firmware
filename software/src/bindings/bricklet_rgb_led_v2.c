...
int tf_rgb_led_v2_create(TF_RGBLEDV2 *rgb_led_v2, const char *uid_or_port_name, TF_HAL *hal) {
    ...
    TF_TFP *tfp;
    int rc = tf_hal_get_attachable_tfp(hal, &tfp, uid_or_port_name, TF_RGB_LED_V2_DEVICE_IDENTIFIER);
...
int tf_rgb_led_v2_set_rgb_value(TF_RGBLEDV2 *rgb_led_v2, uint8_t r, uint8_t g, uint8_t b) {
    ...
    tf_rgb_led_v2_get_response_expected(rgb_led_v2, TF_RGB_LED_V2_FUNCTION_SET_RGB_VALUE, &_response_expected);
    tf_tfp_prepare_send(rgb_led_v2->tfp, TF_RGB_LED_V2_FUNCTION_SET_RGB_VALUE, 3, _response_expected);

    uint8_t *_send_buf = tf_tfp_get_send_payload_buffer(rgb_led_v2->tfp);
    ...
    uint8_t _length = 0;
    int _result = tf_tfp_send_packet(rgb_led_v2->tfp, _response_expected, _deadline, &_error_code, &_length, TF_NEW_PACKET);
...
int tf_rgb_led_v2_get_rgb_value(TF_RGBLEDV2 *rgb_led_v2, uint8_t *ret_r, uint8_t *ret_g, uint8_t *ret_b) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(rgb_led_v2->tfp, TF_RGB_LED_V2_FUNCTION_GET_RGB_VALUE, 0, _response_expected);
    ...
    if (_result & TF_TICK_PACKET_RECEIVED) {
        TF_PacketBuffer *_recv_buf = tf_tfp_get_receive_buffer(rgb_led_v2->tfp);
...
int tf_rgb_led_v2_get_spitfp_error_count(TF_RGBLEDV2 *rgb_led_v2, uint32_t *ret_error_count_ack_checksum, uint32_t *ret_error_count_message_checksum, uint32_t *ret_error_count_frame, uint32_t *ret_error_count_overflow) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(rgb_led_v2->tfp, TF_RGB_LED_V2_FUNCTION_GET_SPITFP_ERROR_COUNT, 0, _response_expected);
...
int tf_rgb_led_v2_set_bootloader_mode(TF_RGBLEDV2 *rgb_led_v2, uint8_t mode, uint8_t *ret_status) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(rgb_led_v2->tfp, TF_RGB_LED_V2_FUNCTION_SET_BOOTLOADER_MODE, 1, _response_expected);
...
int tf_rgb_led_v2_get_bootloader_mode(TF_RGBLEDV2 *rgb_led_v2, uint8_t *ret_mode) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(rgb_led_v2->tfp, TF_RGB_LED_V2_FUNCTION_GET_BOOTLOADER_MODE, 0, _response_expected);
...
int tf_rgb_led_v2_set_write_firmware_pointer(TF_RGBLEDV2 *rgb_led_v2, uint32_t pointer) {
    ...
    bool _response_expected = true;
    tf_rgb_led_v2_get_response_expected(rgb_led_v2, TF_RGB_LED_V2_FUNCTION_SET_WRITE_FIRMWARE_POINTER, &_response_expected);
    tf_tfp_prepare_send(rgb_led_v2->tfp, TF_RGB_LED_V2_FUNCTION_SET_WRITE_FIRMWARE_POINTER, 4, _response_expected);
...
int tf_rgb_led_v2_write_firmware(TF_RGBLEDV2 *rgb_led_v2, const uint8_t data[64], uint8_t *ret_status) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(rgb_led_v2->tfp, TF_RGB_LED_V2_FUNCTION_WRITE_FIRMWARE, 64, _response_expected);
...
int tf_rgb_led_v2_set_status_led_config(TF_RGBLEDV2 *rgb_led_v2, uint8_t config) {
    ...
    bool _response_expected = true;
    tf_rgb_led_v2_get_response_expected(rgb_led_v2, TF_RGB_LED_V2_FUNCTION_SET_STATUS_LED_CONFIG, &_response_expected);
    tf_tfp_prepare_send(rgb_led_v2->tfp, TF_RGB_LED_V2_FUNCTION_SET_STATUS_LED_CONFIG, 1, _response_expected);
...
int tf_rgb_led_v2_get_status_led_config(TF_RGBLEDV2 *rgb_led_v2, uint8_t *ret_config) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(rgb_led_v2->tfp, TF_RGB_LED_V2_FUNCTION_GET_STATUS_LED_CONFIG, 0, _response_expected);
...
int tf_rgb_led_v2_get_chip_temperature(TF_RGBLEDV2 *rgb_led_v2, int16_t *ret_temperature) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(rgb_led_v2->tfp, TF_RGB_LED_V2_FUNCTION_GET_CHIP_TEMPERATURE, 0, _response_expected);
...
int tf_rgb_led_v2_reset(TF_RGBLEDV2 *rgb_led_v2) {
    ...
    bool _response_expected = true;
    tf_rgb_led_v2_get_response_expected(rgb_led_v2, TF_RGB_LED_V2_FUNCTION_RESET, &_response_expected);
    tf_tfp_prepare_send(rgb_led_v2->tfp, TF_RGB_LED_V2_FUNCTION_RESET, 0, _response_expected);
...
int tf_rgb_led_v2_write_uid(TF_RGBLEDV2 *rgb_led_v2, uint32_t uid) {
    ...
    bool _response_expected = true;
    tf_rgb_led_v2_get_response_expected(rgb_led_v2, TF_RGB_LED_V2_FUNCTION_WRITE_UID, &_response_expected);
    tf_tfp_prepare_send(rgb_led_v2->tfp, TF_RGB_LED_V2_FUNCTION_WRITE_UID, 4, _response_expected);
...
int tf_rgb_led_v2_read_uid(TF_RGBLEDV2 *rgb_led_v2, uint32_t *ret_uid) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(rgb_led_v2->tfp, TF_RGB_LED_V2_FUNCTION_READ_UID, 0, _response_expected);
...
int tf_rgb_led_v2_get_identity(TF_RGBLEDV2 *rgb_led_v2, char ret_uid[8], char ret_connected_uid[8], char *ret_position, uint8_t ret_hardware_version[3], uint8_t ret_firmware_version[3], uint16_t *ret_device_identifier) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(rgb_led_v2->tfp, TF_RGB_LED_V2_FUNCTION_GET_IDENTITY, 0, _response_expected);
