...
/**
 * \defgroup TF_GPSV2 GPS Bricklet 2.0
 */
 ...
 * \ingroup TF_GPSV2
 *
 * Removes the device object \c gps_v2 from its HAL and destroys it.
 ...
 * via the tf_gps_v2_set_response_expected function. For setter
