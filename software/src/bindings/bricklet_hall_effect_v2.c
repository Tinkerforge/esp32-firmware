...
static bool tf_hall_effect_v2_callback_handler(void *device, uint8_t fid, TF_PacketBuffer *payload) {
    TF_HallEffectV2 *hall_effect_v2 = (TF_HallEffectV2 *)device;
    TF_HALCommon *hal_common = tf_hal_get_common(hall_effect_v2->tfp->spitfp->hal);
    (void)payload;
...
int tf_hall_effect_v2_create(TF_HallEffectV2 *hall_effect_v2, const char *uid_or_port_name, TF_HAL *hal) {
    if (hall_effect_v2 == NULL || hal == NULL) {
        return TF_E_NULL;
    }
    ...
    TF_TFP *tfp;
    int rc = tf_hal_get_attachable_tfp(hal, &tfp, uid_or_port_name, TF_HALL_EFFECT_V2_DEVICE_IDENTIFIER);
...
int tf_hall_effect_v2_get_magnetic_flux_density(TF_HallEffectV2 *hall_effect_v2, int16_t *ret_magnetic_flux_density) {
    ...
    tf_tfp_prepare_send(hall_effect_v2->tfp, TF_HALL_EFFECT_V2_FUNCTION_GET_MAGNETIC_FLUX_DENSITY, 0, _response_expected);
...
int tf_hall_effect_v2_set_magnetic_flux_density_callback_configuration(TF_HallEffectV2 *hall_effect_v2, uint32_t period, bool value_has_to_change, char option, int16_t min, int16_t max) {
    ...
    bool _response_expected = true;
    tf_hall_effect_v2_get_response_expected(hall_effect_v2, TF_HALL_EFFECT_V2_FUNCTION_SET_MAGNETIC_FLUX_DENSITY_CALLBACK_CONFIGURATION, &_response_expected);
    tf_tfp_prepare_send(hall_effect_v2->tfp, TF_HALL_EFFECT_V2_FUNCTION_SET_MAGNETIC_FLUX_DENSITY_CALLBACK_CONFIGURATION, 10, _response_expected);

    uint8_t *_send_buf = tf_tfp_get_send_payload_buffer(hall_effect_v2->tfp);
...
int tf_hall_effect_v2_get_magnetic_flux_density_callback_configuration(TF_HallEffectV2 *hall_effect_v2, uint32_t *ret_period, bool *ret_value_has_to_change, char *ret_option, int16_t *ret_min, int16_t *ret_max) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(hall_effect_v2->tfp, TF_HALL_EFFECT_V2_FUNCTION_GET_MAGNETIC_FLUX_DENSITY_CALLBACK_CONFIGURATION, 0, _response_expected);
...
int tf_hall_effect_v2_get_counter(TF_HallEffectV2 *hall_effect_v2, bool reset_counter, uint32_t *ret_count) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(hall_effect_v2->tfp, TF_HALL_EFFECT_V2_FUNCTION_GET_COUNTER, 1, _response_expected);

    uint8_t *_send_buf = tf_tfp_get_send_payload_buffer(hall_effect_v2->tfp);

    _send_buf[0] = reset_counter ? 1 : 0;
...
int tf_hall_effect_v2_set_counter_config(TF_HallEffectV2 *hall_effect_v2, int16_t high_threshold, int16_t low_threshold, uint32_t debounce) {
    ...
    bool _response_expected = true;
    tf_hall_effect_v2_get_response_expected(hall_effect_v2, TF_HALL_EFFECT_V2_FUNCTION_SET_COUNTER_CONFIG, &_response_expected);
    tf_tfp_prepare_send(hall_effect_v2->tfp, TF_HALL_EFFECT_V2_FUNCTION_SET_COUNTER_CONFIG, 8, _response_expected);

    uint8_t *_send_buf = tf_tfp_get_send_payload_buffer(hall_effect_v2->tfp);

    high_threshold = tf_leconvert_int16_to(high_threshold); memcpy(_send_buf + 0, &high_threshold, 2);
    low_threshold = tf_leconvert_int16_to(low_threshold); memcpy(_send_buf + 2, &low_threshold, 2);
    debounce = tf_leconvert_uint32_to(debounce); memcpy(_send_buf + 4, &debounce, 4);
...
int tf_hall_effect_v2_get_counter_config(TF_HallEffectV2 *hall_effect_v2, int16_t *ret_high_threshold, int16_t *ret_low_threshold, uint32_t *ret_debounce) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(hall_effect_v2->tfp, TF_HALL_EFFECT_V2_FUNCTION_GET_COUNTER_CONFIG, 0, _response_expected);
    ...
    if (_result & TF_TICK_PACKET_RECEIVED) {
        ...
        if (_error_code != 0 || _length != 8) {
            ...
            if (ret_high_threshold != NULL) { *ret_high_threshold = tf_packet_buffer_read_int16_t(_recv_buf); } else { tf_packet_buffer_remove(_recv_buf, 2); }
            if (ret_low_threshold != NULL) { *ret_low_threshold = tf_packet_buffer_read_int16_t(_recv_buf); } else { tf_packet_buffer_remove(_recv_buf, 2); }
...
int tf_hall_effect_v2_set_counter_callback_configuration(TF_HallEffectV2 *hall_effect_v2, uint32_t period, bool value_has_to_change) {
    ...
    bool _response_expected = true;
    tf_hall_effect_v2_get_response_expected(hall_effect_v2, TF_HALL_EFFECT_V2_FUNCTION_SET_COUNTER_CALLBACK_CONFIGURATION, &_response_expected);
    tf_tfp_prepare_send(hall_effect_v2->tfp, TF_HALL_EFFECT_V2_FUNCTION_SET_COUNTER_CALLBACK_CONFIGURATION, 5, _response_expected);
...
int tf_hall_effect_v2_get_counter_callback_configuration(TF_HallEffectV2 *hall_effect_v2, uint32_t *ret_period, bool *ret_value_has_to_change) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(hall_effect_v2->tfp, TF_HALL_EFFECT_V2_FUNCTION_GET_COUNTER_CALLBACK_CONFIGURATION, 0, _response_expected);
...
int tf_hall_effect_v2_get_spitfp_error_count(TF_HallEffectV2 *hall_effect_v2, uint32_t *ret_error_count_ack_checksum, uint32_t *ret_error_count_message_checksum, uint32_t *ret_error_count_frame, uint32_t *ret_error_count_overflow) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(hall_effect_v2->tfp, TF_HALL_EFFECT_V2_FUNCTION_GET_SPITFP_ERROR_COUNT, 0, _response_expected);
...
int tf_hall_effect_v2_set_bootloader_mode(TF_HallEffectV2 *hall_effect_v2, uint8_t mode, uint8_t *ret_status) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(hall_effect_v2->tfp, TF_HALL_EFFECT_V2_FUNCTION_SET_BOOTLOADER_MODE, 1, _response_expected);
...
int tf_hall_effect_v2_get_bootloader_mode(TF_HallEffectV2 *hall_effect_v2, uint8_t *ret_mode) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(hall_effect_v2->tfp, TF_HALL_EFFECT_V2_FUNCTION_GET_BOOTLOADER_MODE, 0, _response_expected);
...
int tf_hall_effect_v2_set_write_firmware_pointer(TF_HallEffectV2 *hall_effect_v2, uint32_t pointer) {
    ...
    bool _response_expected = true;
    tf_hall_effect_v2_get_response_expected(hall_effect_v2, TF_HALL_EFFECT_V2_FUNCTION_SET_WRITE_FIRMWARE_POINTER, &_response_expected);
    tf_tfp_prepare_send(hall_effect_v2->tfp, TF_HALL_EFFECT_V2_FUNCTION_SET_WRITE_FIRMWARE_POINTER, 4, _response_expected);
...
int tf_hall_effect_v2_write_firmware(TF_HallEffectV2 *hall_effect_v2, const uint8_t data[64], uint8_t *ret_status) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(hall_effect_v2->tfp, TF_HALL_EFFECT_V2_FUNCTION_WRITE_FIRMWARE, 64, _response_expected);
...
int tf_hall_effect_v2_set_status_led_config(TF_HallEffectV2 *hall_effect_v2, uint8_t config) {
    ...
    bool _response_expected = true;
    tf_hall_effect_v2_get_response_expected(hall_effect_v2, TF_HALL_EFFECT_V2_FUNCTION_SET_STATUS_LED_CONFIG, &_response_expected);
    tf_tfp_prepare_send(hall_effect_v2->tfp, TF_HALL_EFFECT_V2_FUNCTION_SET_STATUS_LED_CONFIG, 1, _response_expected);
...
int tf_hall_effect_v2_get_status_led_config(TF_HallEffectV2 *hall_effect_v2, uint8_t *ret_config) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(hall_effect_v2->tfp, TF_HALL_EFFECT_V2_FUNCTION_GET_STATUS_LED_CONFIG, 0, _response_expected);
...
int tf_hall_effect_v2_get_chip_temperature(TF_HallEffectV2 *hall_effect_v2, int16_t *ret_temperature) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(hall_effect_v2->tfp, TF_HALL_EFFECT_V2_FUNCTION_GET_CHIP_TEMPERATURE, 0, _response_expected);
...
int tf_hall_effect_v2_reset(TF_HallEffectV2 *hall_effect_v2) {
    ...
    bool _response_expected = true;
    tf_hall_effect_v2_get_response_expected(hall_effect_v2, TF_HALL_EFFECT_V2_FUNCTION_RESET, &_response_expected);
    tf_tfp_prepare_send(hall_effect_v2->tfp, TF_HALL_EFFECT_V2_FUNCTION_RESET, 0, _response_expected);
...
int tf_hall_effect_v2_write_uid(TF_HallEffectV2 *hall_effect_v2, uint32_t uid) {
    ...
    bool _response_expected = true;
    tf_hall_effect_v2_get_response_expected(hall_effect_v2, TF_HALL_EFFECT_V2_FUNCTION_WRITE_UID, &_response_expected);
    tf_tfp_prepare_send(hall_effect_v2->tfp, TF_HALL_EFFECT_V2_FUNCTION_WRITE_UID, 4, _response_expected);
...
int tf_hall_effect_v2_read_uid(TF_HallEffectV2 *hall_effect_v2, uint32_t *ret_uid) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(hall_effect_v2->tfp, TF_HALL_EFFECT_V2_FUNCTION_READ_UID, 0, _response_expected);
...
int tf_hall_effect_v2_get_identity(TF_HallEffectV2 *hall_effect_v2, char ret_uid[8], char ret_connected_uid[8], char *ret_position, uint8_t ret_hardware_version[3], uint8_t ret_firmware_version[3], uint16_t *ret_device_identifier) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(hall_effect_v2->tfp, TF_HALL_EFFECT_V2_FUNCTION_GET_IDENTITY, 0, _response_expected);
...
int tf_hall_effect_v2_callback_tick(TF_HallEffectV2 *hall_effect_v2, uint32_t timeout_us) {
    ...
    return tf_tfp_callback_tick(hall_effect_v2->tfp, tf_hal_current_time_us(hal) + timeout_us);
}
