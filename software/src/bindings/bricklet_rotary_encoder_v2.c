...
static bool tf_rotary_encoder_v2_callback_handler(void *device, uint8_t fid, TF_PacketBuffer *payload) {
    ...
    switch (fid) {
        case TF_ROTARY_ENCODER_V2_CALLBACK_COUNT: {
            TF_RotaryEncoderV2_CountHandler fn = rotary_encoder_v2->count_handler;
        ...
        case TF_ROTARY_ENCODER_V2_CALLBACK_PRESSED: {
            TF_RotaryEncoderV2_PressedHandler fn = rotary_encoder_v2->pressed_handler;
        ...
        case TF_ROTARY_ENCODER_V2_CALLBACK_RELEASED: {
            TF_RotaryEncoderV2_ReleasedHandler fn = rotary_encoder_v2->released_handler;
...
int tf_rotary_encoder_v2_create(TF_RotaryEncoderV2 *rotary_encoder_v2, const char *uid_or_port_name, TF_HAL *hal) {
    ...
    TF_TFP *tfp;
    int rc = tf_hal_get_attachable_tfp(hal, &tfp, uid_or_port_name, TF_ROTARY_ENCODER_V2_DEVICE_IDENTIFIER);
    ...
    rotary_encoder_v2->magic = 0x5446;
...
int tf_rotary_encoder_v2_destroy(TF_RotaryEncoderV2 *rotary_encoder_v2) {
    ...
    if (rotary_encoder_v2->magic != 0x5446 || rotary_encoder_v2->tfp == NULL) {
...
int tf_rotary_encoder_v2_get_count(TF_RotaryEncoderV2 *rotary_encoder_v2, bool reset, int32_t *ret_count) {
    ...
    TF_HAL *_hal = rotary_encoder_v2->tfp->spitfp->hal;
    ...
    tf_tfp_prepare_send(rotary_encoder_v2->tfp, TF_ROTARY_ENCODER_V2_FUNCTION_GET_COUNT, 1, _response_expected);

    uint8_t *_send_buf = tf_tfp_get_send_payload_buffer(rotary_encoder_v2->tfp);
    ...
    uint8_t _length = 0;
    int _result = tf_tfp_send_packet(rotary_encoder_v2->tfp, _response_expected, _deadline, &_error_code, &_length, TF_NEW_PACKET);
    ...
    if (_result & TF_TICK_PACKET_RECEIVED) {
        TF_PacketBuffer *_recv_buf = tf_tfp_get_receive_buffer(rotary_encoder_v2->tfp);
        if (_error_code != 0 || _length != 4) {
            tf_packet_buffer_remove(_recv_buf, _length);
        } else {
            if (ret_count != NULL) { *ret_count = tf_packet_buffer_read_int32_t(_recv_buf); } else { tf_packet_buffer_remove(_recv_buf, 4); }
        }
...
int tf_rotary_encoder_v2_set_count_callback_configuration(TF_RotaryEncoderV2 *rotary_encoder_v2, uint32_t period, bool value_has_to_change, char option, int32_t min, int32_t max) {
    ...
    bool _response_expected = true;
    tf_rotary_encoder_v2_get_response_expected(rotary_encoder_v2, TF_ROTARY_ENCODER_V2_FUNCTION_SET_COUNT_CALLBACK_CONFIGURATION, &_response_expected);
    tf_tfp_prepare_send(rotary_encoder_v2->tfp, TF_ROTARY_ENCODER_V2_FUNCTION_SET_COUNT_CALLBACK_CONFIGURATION, 14, _response_expected);
...
int tf_rotary_encoder_v2_get_count_callback_configuration(TF_RotaryEncoderV2 *rotary_encoder_v2, uint32_t *ret_period, bool *ret_value_has_to_change, char *ret_option, int32_t *ret_min, int32_t *ret_max) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(rotary_encoder_v2->tfp, TF_ROTARY_ENCODER_V2_FUNCTION_GET_COUNT_CALLBACK_CONFIGURATION, 0, _response_expected);
...
int tf_rotary_encoder_v2_is_pressed(TF_RotaryEncoderV2 *rotary_encoder_v2, bool *ret_pressed) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(rotary_encoder_v2->tfp, TF_ROTARY_ENCODER_V2_FUNCTION_IS_PRESSED, 0, _response_expected);
...
int tf_rotary_encoder_v2_get_spitfp_error_count(TF_RotaryEncoderV2 *rotary_encoder_v2, uint32_t *ret_error_count_ack_checksum, uint32_t *ret_error_count_message_checksum, uint32_t *ret_error_count_frame, uint32_t *ret_error_count_overflow) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(rotary_encoder_v2->tfp, TF_ROTARY_ENCODER_V2_FUNCTION_GET_SPITFP_ERROR_COUNT, 0, _response_expected);
...
int tf_rotary_encoder_v2_set_bootloader_mode(TF_RotaryEncoderV2 *rotary_encoder_v2, uint8_t mode, uint8_t *ret_status) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(rotary_encoder_v2->tfp, TF_ROTARY_ENCODER_V2_FUNCTION_SET_BOOTLOADER_MODE, 1, _response_expected);
...
int tf_rotary_encoder_v2_get_bootloader_mode(TF_RotaryEncoderV2 *rotary_encoder_v2, uint8_t *ret_mode) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(rotary_encoder_v2->tfp, TF_ROTARY_ENCODER_V2_FUNCTION_GET_BOOTLOADER_MODE, 0, _response_expected);
...
int tf_rotary_encoder_v2_set_write_firmware_pointer(TF_RotaryEncoderV2 *rotary_encoder_v2, uint32_t pointer) {
    ...
    bool _response_expected = true;
    tf_rotary_encoder_v2_get_response_expected(rotary_encoder_v2, TF_ROTARY_ENCODER_V2_FUNCTION_SET_WRITE_FIRMWARE_POINTER, &_response_expected);
    tf_tfp_prepare_send(rotary_encoder_v2->tfp, TF_ROTARY_ENCODER_V2_FUNCTION_SET_WRITE_FIRMWARE_POINTER, 4, _response_expected);
...
int tf_rotary_encoder_v2_write_firmware(TF_RotaryEncoderV2 *rotary_encoder_v2, const uint8_t data[64], uint8_t *ret_status) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(rotary_encoder_v2->tfp, TF_ROTARY_ENCODER_V2_FUNCTION_WRITE_FIRMWARE, 64, _response_expected);
...
int tf_rotary_encoder_v2_set_status_led_config(TF_RotaryEncoderV2 *rotary_encoder_v2, uint8_t config) {
    ...
    bool _response_expected = true;
    tf_rotary_encoder_v2_get_response_expected(rotary_encoder_v2, TF_ROTARY_ENCODER_V2_FUNCTION_SET_STATUS_LED_CONFIG, &_response_expected);
    tf_tfp_prepare_send(rotary_encoder_v2->tfp, TF_ROTARY_ENCODER_V2_FUNCTION_SET_STATUS_LED_CONFIG, 1, _response_expected);
...
int tf_rotary_encoder_v2_get_status_led_config(TF_RotaryEncoderV2 *rotary_encoder_v2, uint8_t *ret_config) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(rotary_encoder_v2->tfp, TF_ROTARY_ENCODER_V2_FUNCTION_GET_STATUS_LED_CONFIG, 0, _response_expected);
...
int tf_rotary_encoder_v2_get_chip_temperature(TF_RotaryEncoderV2 *rotary_encoder_v2, int16_t *ret_temperature) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(rotary_encoder_v2->tfp, TF_ROTARY_ENCODER_V2_FUNCTION_GET_CHIP_TEMPERATURE, 0, _response_expected);
...
int tf_rotary_encoder_v2_reset(TF_RotaryEncoderV2 *rotary_encoder_v2) {
    ...
    bool _response_expected = true;
    tf_rotary_encoder_v2_get_response_expected(rotary_encoder_v2, TF_ROTARY_ENCODER_V2_FUNCTION_RESET, &_response_expected);
    tf_tfp_prepare_send(rotary_encoder_v2->tfp, TF_ROTARY_ENCODER_V2_FUNCTION_RESET, 0, _response_expected);
...
int tf_rotary_encoder_v2_write_uid(TF_RotaryEncoderV2 *rotary_encoder_v2, uint32_t uid) {
    ...
    bool _response_expected = true;
    tf_rotary_encoder_v2_get_response_expected(rotary_encoder_v2, TF_ROTARY_ENCODER_V2_FUNCTION_WRITE_UID, &_response_expected);
    tf_tfp_prepare_send(rotary_encoder_v2->tfp, TF_ROTARY_ENCODER_V2_FUNCTION_WRITE_UID, 4, _response_expected);
...
int tf_rotary_encoder_v2_read_uid(TF_RotaryEncoderV2 *rotary_encoder_v2, uint32_t *ret_uid) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(rotary_encoder_v2->tfp, TF_ROTARY_ENCODER_V2_FUNCTION_READ_UID, 0, _response_expected);
...
int tf_rotary_encoder_v2_get_identity(TF_RotaryEncoderV2 *rotary_encoder_v2, char ret_uid[8], char ret_connected_uid[8], char *ret_position, uint8_t ret_hardware_version[3], uint8_t ret_firmware_version[3], uint16_t *ret_device_identifier) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(rotary_encoder_v2->tfp, TF_ROTARY_ENCODER_V2_FUNCTION_GET_IDENTITY, 0, _response_expected);
