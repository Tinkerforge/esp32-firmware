...
static bool tf_dc_v2_callback_handler(void *device, uint8_t fid, TF_PacketBuffer *payload) {
    TF_DCV2 *dc_v2 = (TF_DCV2 *)device;
    TF_HALCommon *hal_common = tf_hal_get_common(dc_v2->tfp->spitfp->hal);
    (void)payload;
...
int tf_dc_v2_create(TF_DCV2 *dc_v2, const char *uid_or_port_name, TF_HAL *hal) {
    ...
    TF_TFP *tfp;
    int rc = tf_hal_get_attachable_tfp(hal, &tfp, uid_or_port_name, TF_DC_V2_DEVICE_IDENTIFIER);
...
int tf_dc_v2_set_enabled(TF_DCV2 *dc_v2, bool enabled) {
    ...
    tf_dc_v2_get_response_expected(dc_v2, TF_DC_V2_FUNCTION_SET_ENABLED, &_response_expected);
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_SET_ENABLED, 1, _response_expected);

    uint8_t *_send_buf = tf_tfp_get_send_payload_buffer(dc_v2->tfp);
    ...
    uint8_t _length = 0;
    int _result = tf_tfp_send_packet(dc_v2->tfp, _response_expected, _deadline, &_error_code, &_length, TF_NEW_PACKET);
    ...
    if (_result & TF_TICK_TIMEOUT) {
        _result = tf_tfp_finish_send(dc_v2->tfp, _result, _deadline);
        (void) _result;
        return TF_E_TIMEOUT;
    }
...
int tf_dc_v2_get_enabled(TF_DCV2 *dc_v2, bool *ret_enabled) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_GET_ENABLED, 0, _response_expected);
    ...
    if (_result & TF_TICK_PACKET_RECEIVED) {
        TF_PacketBuffer *_recv_buf = tf_tfp_get_receive_buffer(dc_v2->tfp);
...
int tf_dc_v2_set_velocity(TF_DCV2 *dc_v2, int16_t velocity) {
    ...
    bool _response_expected = true;
    tf_dc_v2_get_response_expected(dc_v2, TF_DC_V2_FUNCTION_SET_VELOCITY, &_response_expected);
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_SET_VELOCITY, 2, _response_expected);
...
int tf_dc_v2_get_velocity(TF_DCV2 *dc_v2, int16_t *ret_velocity) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_GET_VELOCITY, 0, _response_expected);
...
int tf_dc_v2_get_current_velocity(TF_DCV2 *dc_v2, int16_t *ret_velocity) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_GET_CURRENT_VELOCITY, 0, _response_expected);
...
int tf_dc_v2_set_motion(TF_DCV2 *dc_v2, uint16_t acceleration, uint16_t deceleration) {
    ...
    bool _response_expected = true;
    tf_dc_v2_get_response_expected(dc_v2, TF_DC_V2_FUNCTION_SET_MOTION, &_response_expected);
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_SET_MOTION, 4, _response_expected);
...
int tf_dc_v2_get_motion(TF_DCV2 *dc_v2, uint16_t *ret_acceleration, uint16_t *ret_deceleration) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_GET_MOTION, 0, _response_expected);
...
int tf_dc_v2_full_brake(TF_DCV2 *dc_v2) {
    ...
    bool _response_expected = true;
    tf_dc_v2_get_response_expected(dc_v2, TF_DC_V2_FUNCTION_FULL_BRAKE, &_response_expected);
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_FULL_BRAKE, 0, _response_expected);
...
int tf_dc_v2_set_drive_mode(TF_DCV2 *dc_v2, uint8_t mode) {
    ...
    bool _response_expected = true;
    tf_dc_v2_get_response_expected(dc_v2, TF_DC_V2_FUNCTION_SET_DRIVE_MODE, &_response_expected);
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_SET_DRIVE_MODE, 1, _response_expected);
...
int tf_dc_v2_get_drive_mode(TF_DCV2 *dc_v2, uint8_t *ret_mode) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_GET_DRIVE_MODE, 0, _response_expected);
...
int tf_dc_v2_set_pwm_frequency(TF_DCV2 *dc_v2, uint16_t frequency) {
    ...
    bool _response_expected = true;
    tf_dc_v2_get_response_expected(dc_v2, TF_DC_V2_FUNCTION_SET_PWM_FREQUENCY, &_response_expected);
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_SET_PWM_FREQUENCY, 2, _response_expected);
...
int tf_dc_v2_get_pwm_frequency(TF_DCV2 *dc_v2, uint16_t *ret_frequency) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_GET_PWM_FREQUENCY, 0, _response_expected);
...
int tf_dc_v2_get_power_statistics(TF_DCV2 *dc_v2, uint16_t *ret_voltage, uint16_t *ret_current) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_GET_POWER_STATISTICS, 0, _response_expected);
...
int tf_dc_v2_set_error_led_config(TF_DCV2 *dc_v2, uint8_t config) {
    ...
    bool _response_expected = true;
    tf_dc_v2_get_response_expected(dc_v2, TF_DC_V2_FUNCTION_SET_ERROR_LED_CONFIG, &_response_expected);
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_SET_ERROR_LED_CONFIG, 1, _response_expected);
...
int tf_dc_v2_get_error_led_config(TF_DCV2 *dc_v2, uint8_t *ret_config) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_GET_ERROR_LED_CONFIG, 0, _response_expected);
...
int tf_dc_v2_set_emergency_shutdown_callback_configuration(TF_DCV2 *dc_v2, bool enabled) {
    ...
    bool _response_expected = true;
    tf_dc_v2_get_response_expected(dc_v2, TF_DC_V2_FUNCTION_SET_EMERGENCY_SHUTDOWN_CALLBACK_CONFIGURATION, &_response_expected);
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_SET_EMERGENCY_SHUTDOWN_CALLBACK_CONFIGURATION, 1, _response_expected);
...
int tf_dc_v2_get_emergency_shutdown_callback_configuration(TF_DCV2 *dc_v2, bool *ret_enabled) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_GET_EMERGENCY_SHUTDOWN_CALLBACK_CONFIGURATION, 0, _response_expected);
...
int tf_dc_v2_set_velocity_reached_callback_configuration(TF_DCV2 *dc_v2, bool enabled) {
    ...
    bool _response_expected = true;
    tf_dc_v2_get_response_expected(dc_v2, TF_DC_V2_FUNCTION_SET_VELOCITY_REACHED_CALLBACK_CONFIGURATION, &_response_expected);
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_SET_VELOCITY_REACHED_CALLBACK_CONFIGURATION, 1, _response_expected);
...
int tf_dc_v2_get_velocity_reached_callback_configuration(TF_DCV2 *dc_v2, bool *ret_enabled) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_GET_VELOCITY_REACHED_CALLBACK_CONFIGURATION, 0, _response_expected);
...
int tf_dc_v2_set_current_velocity_callback_configuration(TF_DCV2 *dc_v2, uint32_t period, bool value_has_to_change) {
    ...
    bool _response_expected = true;
    tf_dc_v2_get_response_expected(dc_v2, TF_DC_V2_FUNCTION_SET_CURRENT_VELOCITY_CALLBACK_CONFIGURATION, &_response_expected);
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_SET_CURRENT_VELOCITY_CALLBACK_CONFIGURATION, 5, _response_expected);
...
int tf_dc_v2_get_current_velocity_callback_configuration(TF_DCV2 *dc_v2, uint32_t *ret_period, bool *ret_value_has_to_change) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_GET_CURRENT_VELOCITY_CALLBACK_CONFIGURATION, 0, _response_expected);
...
int tf_dc_v2_get_spitfp_error_count(TF_DCV2 *dc_v2, uint32_t *ret_error_count_ack_checksum, uint32_t *ret_error_count_message_checksum, uint32_t *ret_error_count_frame, uint32_t *ret_error_count_overflow) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_GET_SPITFP_ERROR_COUNT, 0, _response_expected);
...
int tf_dc_v2_set_bootloader_mode(TF_DCV2 *dc_v2, uint8_t mode, uint8_t *ret_status) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_SET_BOOTLOADER_MODE, 1, _response_expected);
...
int tf_dc_v2_get_bootloader_mode(TF_DCV2 *dc_v2, uint8_t *ret_mode) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_GET_BOOTLOADER_MODE, 0, _response_expected);
...
int tf_dc_v2_set_write_firmware_pointer(TF_DCV2 *dc_v2, uint32_t pointer) {
    ...
    bool _response_expected = true;
    tf_dc_v2_get_response_expected(dc_v2, TF_DC_V2_FUNCTION_SET_WRITE_FIRMWARE_POINTER, &_response_expected);
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_SET_WRITE_FIRMWARE_POINTER, 4, _response_expected);
...
int tf_dc_v2_write_firmware(TF_DCV2 *dc_v2, const uint8_t data[64], uint8_t *ret_status) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_WRITE_FIRMWARE, 64, _response_expected);
...
int tf_dc_v2_set_status_led_config(TF_DCV2 *dc_v2, uint8_t config) {
    ...
    bool _response_expected = true;
    tf_dc_v2_get_response_expected(dc_v2, TF_DC_V2_FUNCTION_SET_STATUS_LED_CONFIG, &_response_expected);
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_SET_STATUS_LED_CONFIG, 1, _response_expected);
...
int tf_dc_v2_get_status_led_config(TF_DCV2 *dc_v2, uint8_t *ret_config) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_GET_STATUS_LED_CONFIG, 0, _response_expected);
...
int tf_dc_v2_get_chip_temperature(TF_DCV2 *dc_v2, int16_t *ret_temperature) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_GET_CHIP_TEMPERATURE, 0, _response_expected);
...
int tf_dc_v2_reset(TF_DCV2 *dc_v2) {
    ...
    bool _response_expected = true;
    tf_dc_v2_get_response_expected(dc_v2, TF_DC_V2_FUNCTION_RESET, &_response_expected);
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_RESET, 0, _response_expected);
...
int tf_dc_v2_write_uid(TF_DCV2 *dc_v2, uint32_t uid) {
    ...
    bool _response_expected = true;
    tf_dc_v2_get_response_expected(dc_v2, TF_DC_V2_FUNCTION_WRITE_UID, &_response_expected);
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_WRITE_UID, 4, _response_expected);
...
int tf_dc_v2_read_uid(TF_DCV2 *dc_v2, uint32_t *ret_uid) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_READ_UID, 0, _response_expected);
...
int tf_dc_v2_get_identity(TF_DCV2 *dc_v2, char ret_uid[8], char ret_connected_uid[8], char *ret_position, uint8_t ret_hardware_version[3], uint8_t ret_firmware_version[3], uint16_t *ret_device_identifier) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(dc_v2->tfp, TF_DC_V2_FUNCTION_GET_IDENTITY, 0, _response_expected);
...
int tf_dc_v2_callback_tick(TF_DCV2 *dc_v2, uint32_t timeout_us) {
    ...
    return tf_tfp_callback_tick(dc_v2->tfp, tf_hal_current_time_us(hal) + timeout_us);
}
