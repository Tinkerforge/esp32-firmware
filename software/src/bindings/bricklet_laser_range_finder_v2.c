...
int tf_laser_range_finder_v2_get_distance(TF_LaserRangeFinderV2 *laser_range_finder_v2, int16_t *ret_distance) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_distance != NULL) { *ret_distance = tf_packetbuffer_read_int16_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packetbuffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 2); }
...
int tf_laser_range_finder_v2_get_distance_callback_configuration(TF_LaserRangeFinderV2 *laser_range_finder_v2, uint32_t *ret_period, bool *ret_value_has_to_change, char *ret_option, int16_t *ret_min, int16_t *ret_max) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_period != NULL) { *ret_period = tf_packetbuffer_read_uint32_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packetbuffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 4); }
        if (ret_value_has_to_change != NULL) { *ret_value_has_to_change = tf_packetbuffer_read_bool(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packetbuffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 1); }
        if (ret_option != NULL) { *ret_option = tf_packetbuffer_read_char(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packetbuffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 1); }
        if (ret_min != NULL) { *ret_min = tf_packetbuffer_read_int16_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packetbuffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 2); }
        if (ret_max != NULL) { *ret_max = tf_packetbuffer_read_int16_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packetbuffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 2); }
        tf_tfp_packet_processed(laser_range_finder_v2->tfp);
    }
...
int tf_laser_range_finder_v2_get_velocity(TF_LaserRangeFinderV2 *laser_range_finder_v2, int16_t *ret_velocity) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_velocity != NULL) { *ret_velocity = tf_packetbuffer_read_int16_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packetbuffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 2); }
        tf_tfp_packet_processed(laser_range_finder_v2->tfp);
    }
...
int tf_laser_range_finder_v2_get_enable(TF_LaserRangeFinderV2 *laser_range_finder_v2, bool *ret_enable) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_enable != NULL) { *ret_enable = tf_packetbuffer_read_bool(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packetbuffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 1); }
        tf_tfp_packet_processed(laser_range_finder_v2->tfp);
    }
...
int tf_laser_range_finder_v2_get_configuration(TF_LaserRangeFinderV2 *laser_range_finder_v2, uint8_t *ret_acquisition_count, bool *ret_enable_quick_termination, uint8_t *ret_threshold_value, uint16_t *ret_measurement_frequency) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_acquisition_count != NULL) { *ret_acquisition_count = tf_packetbuffer_read_uint8_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packetbuffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 1); }
        if (ret_enable_quick_termination != NULL) { *ret_enable_quick_termination = tf_packetbuffer_read_bool(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packetbuffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 1); }
        if (ret_threshold_value != NULL) { *ret_threshold_value = tf_packetbuffer_read_uint8_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packetbuffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 1); }
        if (ret_measurement_frequency != NULL) { *ret_measurement_frequency = tf_packetbuffer_read_uint16_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packetbuffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 2); }
        tf_tfp_packet_processed(laser_range_finder_v2->tfp);
    }
...
int tf_laser_range_finder_v2_get_moving_average(TF_LaserRangeFinderV2 *laser_range_finder_v2, uint8_t *ret_distance_average_length, uint8_t *ret_velocity_average_length) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_distance_average_length != NULL) { *ret_distance_average_length = tf_packetbuffer_read_uint8_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packetbuffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 1); }
        if (ret_velocity_average_length != NULL) { *ret_velocity_average_length = tf_packetbuffer_read_uint8_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packetbuffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 1); }
        tf_tfp_packet_processed(laser_range_finder_v2->tfp);
    }
...
int tf_laser_range_finder_v2_get_offset_calibration(TF_LaserRangeFinderV2 *laser_range_finder_v2, int16_t *ret_offset) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_offset != NULL) { *ret_offset = tf_packetbuffer_read_int16_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packetbuffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 2); }
        tf_tfp_packet_processed(laser_range_finder_v2->tfp);
    }
...
int tf_laser_range_finder_v2_get_distance_led_config(TF_LaserRangeFinderV2 *laser_range_finder_v2, uint8_t *ret_config) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_config != NULL) { *ret_config = tf_packetbuffer_read_uint8_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packetbuffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 1); }
        tf_tfp_packet_processed(laser_range_finder_v2->tfp);
    }
...
int tf_laser_range_finder_v2_get_spitfp_error_count(TF_LaserRangeFinderV2 *laser_range_finder_v2, uint32_t *ret_error_count_ack_checksum, uint32_t *ret_error_count_message_checksum, uint32_t *ret_error_count_frame, uint32_t *ret_error_count_overflow) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_error_count_ack_checksum != NULL) { *ret_error_count_ack_checksum = tf_packetbuffer_read_uint32_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packetbuffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 4); }
        if (ret_error_count_message_checksum != NULL) { *ret_error_count_message_checksum = tf_packetbuffer_read_uint32_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packetbuffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 4); }
        if (ret_error_count_frame != NULL) { *ret_error_count_frame = tf_packetbuffer_read_uint32_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packetbuffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 4); }
        if (ret_error_count_overflow != NULL) { *ret_error_count_overflow = tf_packetbuffer_read_uint32_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packetbuffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 4); }
        tf_tfp_packet_processed(laser_range_finder_v2->tfp);
    }
...
int tf_laser_range_finder_v2_set_bootloader_mode(TF_LaserRangeFinderV2 *laser_range_finder_v2, uint8_t mode, uint8_t *ret_status) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_status != NULL) { *ret_status = tf_packetbuffer_read_uint8_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packetbuffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 1); }
        tf_tfp_packet_processed(laser_range_finder_v2->tfp);
    }
...
int tf_laser_range_finder_v2_get_bootloader_mode(TF_LaserRangeFinderV2 *laser_range_finder_v2, uint8_t *ret_mode) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_mode != NULL) { *ret_mode = tf_packetbuffer_read_uint8_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packetbuffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 1); }
        tf_tfp_packet_processed(laser_range_finder_v2->tfp);
    }
...
int tf_laser_range_finder_v2_get_chip_temperature(TF_LaserRangeFinderV2 *laser_range_finder_v2, int16_t *ret_temperature) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_temperature != NULL) { *ret_temperature = tf_packetbuffer_read_int16_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packetbuffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 2); }
        tf_tfp_packet_processed(laser_range_finder_v2->tfp);
    }
...
int tf_laser_range_finder_v2_read_uid(TF_LaserRangeFinderV2 *laser_range_finder_v2, uint32_t *ret_uid) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_uid != NULL) { *ret_uid = tf_packetbuffer_read_uint32_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packetbuffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 4); }
        tf_tfp_packet_processed(laser_range_finder_v2->tfp);
    }
