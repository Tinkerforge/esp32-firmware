...
static bool tf_laser_range_finder_v2_callback_handler(void *dev, uint8_t fid, TF_PacketBuffer *payload) {
    ...
    switch (fid) {
        ...
        case TF_LASER_RANGE_FINDER_V2_CALLBACK_DISTANCE: {
            TF_LaserRangeFinderV2DistanceHandler fn = laser_range_finder_v2->distance_handler;
            ...
            TF_HALCommon *hal_common = tf_hal_get_common((TF_HAL*)laser_range_finder_v2->tfp->hal);
        ...
        case TF_LASER_RANGE_FINDER_V2_CALLBACK_VELOCITY: {
            TF_LaserRangeFinderV2VelocityHandler fn = laser_range_finder_v2->velocity_handler;
...
int tf_laser_range_finder_v2_get_distance(TF_LaserRangeFinderV2 *laser_range_finder_v2, int16_t *ret_distance) {
    ...
    if (tf_hal_get_common((TF_HAL*)laser_range_finder_v2->tfp->hal)->locked) {
        return TF_E_LOCKED;
    }
    ...
    uint32_t deadline = tf_hal_current_time_us((TF_HAL*)laser_range_finder_v2->tfp->hal) + tf_hal_get_common((TF_HAL*)laser_range_finder_v2->tfp->hal)->timeout;
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_distance != NULL) { *ret_distance = tf_packet_buffer_read_int16_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 2); }
...
int tf_laser_range_finder_v2_set_distance_callback_configuration(TF_LaserRangeFinderV2 *laser_range_finder_v2, uint32_t period, bool value_has_to_change, char option, int16_t min, int16_t max) {
    ...
    uint8_t *buf = tf_tfp_get_payload_buffer(laser_range_finder_v2->tfp);
...
int tf_laser_range_finder_v2_get_distance_callback_configuration(TF_LaserRangeFinderV2 *laser_range_finder_v2, uint32_t *ret_period, bool *ret_value_has_to_change, char *ret_option, int16_t *ret_min, int16_t *ret_max) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_period != NULL) { *ret_period = tf_packet_buffer_read_uint32_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 4); }
        if (ret_value_has_to_change != NULL) { *ret_value_has_to_change = tf_packet_buffer_read_bool(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 1); }
        if (ret_option != NULL) { *ret_option = tf_packet_buffer_read_char(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 1); }
        if (ret_min != NULL) { *ret_min = tf_packet_buffer_read_int16_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 2); }
        if (ret_max != NULL) { *ret_max = tf_packet_buffer_read_int16_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 2); }
        tf_tfp_packet_processed(laser_range_finder_v2->tfp);
    }
...
int tf_laser_range_finder_v2_get_velocity(TF_LaserRangeFinderV2 *laser_range_finder_v2, int16_t *ret_velocity) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_velocity != NULL) { *ret_velocity = tf_packet_buffer_read_int16_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 2); }
        tf_tfp_packet_processed(laser_range_finder_v2->tfp);
    }
...
int tf_laser_range_finder_v2_get_enable(TF_LaserRangeFinderV2 *laser_range_finder_v2, bool *ret_enable) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_enable != NULL) { *ret_enable = tf_packet_buffer_read_bool(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 1); }
        tf_tfp_packet_processed(laser_range_finder_v2->tfp);
    }
...
int tf_laser_range_finder_v2_set_configuration(TF_LaserRangeFinderV2 *laser_range_finder_v2, uint8_t acquisition_count, bool enable_quick_termination, uint8_t threshold_value, uint16_t measurement_frequency) {
    ...
    buf[0] = (uint8_t)acquisition_count;
    buf[1] = enable_quick_termination ? 1 : 0;
...
int tf_laser_range_finder_v2_get_configuration(TF_LaserRangeFinderV2 *laser_range_finder_v2, uint8_t *ret_acquisition_count, bool *ret_enable_quick_termination, uint8_t *ret_threshold_value, uint16_t *ret_measurement_frequency) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_acquisition_count != NULL) { *ret_acquisition_count = tf_packet_buffer_read_uint8_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 1); }
        if (ret_enable_quick_termination != NULL) { *ret_enable_quick_termination = tf_packet_buffer_read_bool(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 1); }
        if (ret_threshold_value != NULL) { *ret_threshold_value = tf_packet_buffer_read_uint8_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 1); }
        if (ret_measurement_frequency != NULL) { *ret_measurement_frequency = tf_packet_buffer_read_uint16_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 2); }
        tf_tfp_packet_processed(laser_range_finder_v2->tfp);
    }
...
int tf_laser_range_finder_v2_get_moving_average(TF_LaserRangeFinderV2 *laser_range_finder_v2, uint8_t *ret_distance_average_length, uint8_t *ret_velocity_average_length) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_distance_average_length != NULL) { *ret_distance_average_length = tf_packet_buffer_read_uint8_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 1); }
        if (ret_velocity_average_length != NULL) { *ret_velocity_average_length = tf_packet_buffer_read_uint8_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 1); }
        tf_tfp_packet_processed(laser_range_finder_v2->tfp);
    }
...
int tf_laser_range_finder_v2_get_offset_calibration(TF_LaserRangeFinderV2 *laser_range_finder_v2, int16_t *ret_offset) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_offset != NULL) { *ret_offset = tf_packet_buffer_read_int16_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 2); }
        tf_tfp_packet_processed(laser_range_finder_v2->tfp);
    }
...
int tf_laser_range_finder_v2_get_distance_led_config(TF_LaserRangeFinderV2 *laser_range_finder_v2, uint8_t *ret_config) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_config != NULL) { *ret_config = tf_packet_buffer_read_uint8_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 1); }
        tf_tfp_packet_processed(laser_range_finder_v2->tfp);
    }
...
int tf_laser_range_finder_v2_get_spitfp_error_count(TF_LaserRangeFinderV2 *laser_range_finder_v2, uint32_t *ret_error_count_ack_checksum, uint32_t *ret_error_count_message_checksum, uint32_t *ret_error_count_frame, uint32_t *ret_error_count_overflow) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_error_count_ack_checksum != NULL) { *ret_error_count_ack_checksum = tf_packet_buffer_read_uint32_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 4); }
        if (ret_error_count_message_checksum != NULL) { *ret_error_count_message_checksum = tf_packet_buffer_read_uint32_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 4); }
        if (ret_error_count_frame != NULL) { *ret_error_count_frame = tf_packet_buffer_read_uint32_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 4); }
        if (ret_error_count_overflow != NULL) { *ret_error_count_overflow = tf_packet_buffer_read_uint32_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 4); }
        tf_tfp_packet_processed(laser_range_finder_v2->tfp);
    }
...
int tf_laser_range_finder_v2_set_bootloader_mode(TF_LaserRangeFinderV2 *laser_range_finder_v2, uint8_t mode, uint8_t *ret_status) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_status != NULL) { *ret_status = tf_packet_buffer_read_uint8_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 1); }
        tf_tfp_packet_processed(laser_range_finder_v2->tfp);
    }
...
int tf_laser_range_finder_v2_get_bootloader_mode(TF_LaserRangeFinderV2 *laser_range_finder_v2, uint8_t *ret_mode) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_mode != NULL) { *ret_mode = tf_packet_buffer_read_uint8_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 1); }
        tf_tfp_packet_processed(laser_range_finder_v2->tfp);
    }
...
int tf_laser_range_finder_v2_get_chip_temperature(TF_LaserRangeFinderV2 *laser_range_finder_v2, int16_t *ret_temperature) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_temperature != NULL) { *ret_temperature = tf_packet_buffer_read_int16_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 2); }
        tf_tfp_packet_processed(laser_range_finder_v2->tfp);
    }
...
int tf_laser_range_finder_v2_read_uid(TF_LaserRangeFinderV2 *laser_range_finder_v2, uint32_t *ret_uid) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_uid != NULL) { *ret_uid = tf_packet_buffer_read_uint32_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 4); }
        tf_tfp_packet_processed(laser_range_finder_v2->tfp);
    }
...
int tf_laser_range_finder_v2_get_identity(TF_LaserRangeFinderV2 *laser_range_finder_v2, char ret_uid[8], char ret_connected_uid[8], char *ret_position, uint8_t ret_hardware_version[3], uint8_t ret_firmware_version[3], uint16_t *ret_device_identifier) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        ...
        if (ret_uid != NULL) { tf_packet_buffer_pop_n(&laser_range_finder_v2->tfp->spitfp->recv_buf, (uint8_t*)ret_uid, 8);} else { tf_packet_buffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 8); }
        tf_packet_buffer_pop_n(&laser_range_finder_v2->tfp->spitfp->recv_buf, (uint8_t*)tmp_connected_uid, 8);
        if (ret_position != NULL) { *ret_position = tf_packet_buffer_read_char(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 1); }
        if (ret_hardware_version != NULL) { for (i = 0; i < 3; ++i) ret_hardware_version[i] = tf_packet_buffer_read_uint8_t(&laser_range_finder_v2->tfp->spitfp->recv_buf);} else { tf_packet_buffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 3); }
        if (ret_firmware_version != NULL) { for (i = 0; i < 3; ++i) ret_firmware_version[i] = tf_packet_buffer_read_uint8_t(&laser_range_finder_v2->tfp->spitfp->recv_buf);} else { tf_packet_buffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 3); }
        if (ret_device_identifier != NULL) { *ret_device_identifier = tf_packet_buffer_read_uint16_t(&laser_range_finder_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&laser_range_finder_v2->tfp->spitfp->recv_buf, 2); }
        if (tmp_connected_uid[0] == 0 && ret_position != NULL) {
            *ret_position = tf_hal_get_port_name((TF_HAL*)laser_range_finder_v2->tfp->hal, laser_range_finder_v2->tfp->spitfp->port_id);
        }
...
int tf_laser_range_finder_v2_callback_tick(TF_LaserRangeFinderV2 *laser_range_finder_v2, uint32_t timeout_us) {
    ...
    return tf_tfp_callback_tick(laser_range_finder_v2->tfp, tf_hal_current_time_us((TF_HAL*)laser_range_finder_v2->tfp->hal) + timeout_us);
}
