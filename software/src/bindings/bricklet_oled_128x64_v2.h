...
#ifndef TF_OLED_128X64_V2_H
#define TF_OLED_128X64_V2_H
...
/**
 * \defgroup TF_OLED128x64V2 OLED 128x64 Bricklet 2.0
 */
 ...
 * \ingroup TF_OLED128x64V2
 *
 * Removes the device object \c oled_128x64_v2 from its HAL and destroys it.
 ...
 * via the tf_oled_128x64_v2_set_response_expected function. For setter
