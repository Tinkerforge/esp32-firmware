...
#ifndef TF_SERVO_V2_H
#define TF_SERVO_V2_H
...
/**
 * \defgroup TF_ServoV2 Servo Bricklet 2.0
 */

struct TF_ServoV2;
#if TF_IMPLEMENT_CALLBACKS != 0

typedef void (*TF_ServoV2_PositionReachedHandler)(struct TF_ServoV2 *servo_v2, uint16_t servo_channel, int16_t position, void *user_data);
...
typedef struct TF_ServoV2 {
    TF_TFP *tfp;
#if TF_IMPLEMENT_CALLBACKS != 0
    TF_ServoV2_PositionReachedHandler position_reached_handler;
 ...
 * \ingroup TF_ServoV2
 *
 * Removes the device object \c servo_v2 from its HAL and destroys it.
 ...
 * via the tf_servo_v2_set_response_expected function. For setter
