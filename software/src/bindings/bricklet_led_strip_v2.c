...
int tf_led_strip_v2_get_led_values_low_level(TF_LEDStripV2 *led_strip_v2, uint16_t index, uint16_t length, uint16_t *ret_value_length, uint16_t *ret_value_chunk_offset, uint8_t ret_value_chunk_data[60]) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_value_length != NULL) { *ret_value_length = tf_packet_buffer_read_uint16_t(&led_strip_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&led_strip_v2->tfp->spitfp->recv_buf, 2); }
        if (ret_value_chunk_offset != NULL) { *ret_value_chunk_offset = tf_packet_buffer_read_uint16_t(&led_strip_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&led_strip_v2->tfp->spitfp->recv_buf, 2); }
        if (ret_value_chunk_data != NULL) { for (i = 0; i < 60; ++i) ret_value_chunk_data[i] = tf_packet_buffer_read_uint8_t(&led_strip_v2->tfp->spitfp->recv_buf);} else { tf_packet_buffer_remove(&led_strip_v2->tfp->spitfp->recv_buf, 60); }
...
int tf_led_strip_v2_get_frame_duration(TF_LEDStripV2 *led_strip_v2, uint16_t *ret_duration) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_duration != NULL) { *ret_duration = tf_packet_buffer_read_uint16_t(&led_strip_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&led_strip_v2->tfp->spitfp->recv_buf, 2); }
        tf_tfp_packet_processed(led_strip_v2->tfp);
    }
...
int tf_led_strip_v2_get_supply_voltage(TF_LEDStripV2 *led_strip_v2, uint16_t *ret_voltage) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_voltage != NULL) { *ret_voltage = tf_packet_buffer_read_uint16_t(&led_strip_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&led_strip_v2->tfp->spitfp->recv_buf, 2); }
        tf_tfp_packet_processed(led_strip_v2->tfp);
    }
...
int tf_led_strip_v2_get_clock_frequency(TF_LEDStripV2 *led_strip_v2, uint32_t *ret_frequency) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_frequency != NULL) { *ret_frequency = tf_packet_buffer_read_uint32_t(&led_strip_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&led_strip_v2->tfp->spitfp->recv_buf, 4); }
        tf_tfp_packet_processed(led_strip_v2->tfp);
    }
...
int tf_led_strip_v2_get_chip_type(TF_LEDStripV2 *led_strip_v2, uint16_t *ret_chip) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_chip != NULL) { *ret_chip = tf_packet_buffer_read_uint16_t(&led_strip_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&led_strip_v2->tfp->spitfp->recv_buf, 2); }
        tf_tfp_packet_processed(led_strip_v2->tfp);
    }
...
int tf_led_strip_v2_get_channel_mapping(TF_LEDStripV2 *led_strip_v2, uint8_t *ret_mapping) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_mapping != NULL) { *ret_mapping = tf_packet_buffer_read_uint8_t(&led_strip_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&led_strip_v2->tfp->spitfp->recv_buf, 1); }
        tf_tfp_packet_processed(led_strip_v2->tfp);
    }
...
int tf_led_strip_v2_get_frame_started_callback_configuration(TF_LEDStripV2 *led_strip_v2, bool *ret_enable) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_enable != NULL) { *ret_enable = tf_packet_buffer_read_bool(&led_strip_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&led_strip_v2->tfp->spitfp->recv_buf, 1); }
        tf_tfp_packet_processed(led_strip_v2->tfp);
    }
...
int tf_led_strip_v2_get_spitfp_error_count(TF_LEDStripV2 *led_strip_v2, uint32_t *ret_error_count_ack_checksum, uint32_t *ret_error_count_message_checksum, uint32_t *ret_error_count_frame, uint32_t *ret_error_count_overflow) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_error_count_ack_checksum != NULL) { *ret_error_count_ack_checksum = tf_packet_buffer_read_uint32_t(&led_strip_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&led_strip_v2->tfp->spitfp->recv_buf, 4); }
        if (ret_error_count_message_checksum != NULL) { *ret_error_count_message_checksum = tf_packet_buffer_read_uint32_t(&led_strip_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&led_strip_v2->tfp->spitfp->recv_buf, 4); }
        if (ret_error_count_frame != NULL) { *ret_error_count_frame = tf_packet_buffer_read_uint32_t(&led_strip_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&led_strip_v2->tfp->spitfp->recv_buf, 4); }
        if (ret_error_count_overflow != NULL) { *ret_error_count_overflow = tf_packet_buffer_read_uint32_t(&led_strip_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&led_strip_v2->tfp->spitfp->recv_buf, 4); }
        tf_tfp_packet_processed(led_strip_v2->tfp);
    }
...
int tf_led_strip_v2_set_bootloader_mode(TF_LEDStripV2 *led_strip_v2, uint8_t mode, uint8_t *ret_status) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_status != NULL) { *ret_status = tf_packet_buffer_read_uint8_t(&led_strip_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&led_strip_v2->tfp->spitfp->recv_buf, 1); }
        tf_tfp_packet_processed(led_strip_v2->tfp);
    }
...
int tf_led_strip_v2_get_bootloader_mode(TF_LEDStripV2 *led_strip_v2, uint8_t *ret_mode) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_mode != NULL) { *ret_mode = tf_packet_buffer_read_uint8_t(&led_strip_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&led_strip_v2->tfp->spitfp->recv_buf, 1); }
        tf_tfp_packet_processed(led_strip_v2->tfp);
    }
...
int tf_led_strip_v2_get_status_led_config(TF_LEDStripV2 *led_strip_v2, uint8_t *ret_config) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_config != NULL) { *ret_config = tf_packet_buffer_read_uint8_t(&led_strip_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&led_strip_v2->tfp->spitfp->recv_buf, 1); }
        tf_tfp_packet_processed(led_strip_v2->tfp);
    }
...
int tf_led_strip_v2_get_chip_temperature(TF_LEDStripV2 *led_strip_v2, int16_t *ret_temperature) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_temperature != NULL) { *ret_temperature = tf_packet_buffer_read_int16_t(&led_strip_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&led_strip_v2->tfp->spitfp->recv_buf, 2); }
        tf_tfp_packet_processed(led_strip_v2->tfp);
    }
...
int tf_led_strip_v2_read_uid(TF_LEDStripV2 *led_strip_v2, uint32_t *ret_uid) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        if (ret_uid != NULL) { *ret_uid = tf_packet_buffer_read_uint32_t(&led_strip_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&led_strip_v2->tfp->spitfp->recv_buf, 4); }
        tf_tfp_packet_processed(led_strip_v2->tfp);
    }
...
int tf_led_strip_v2_get_identity(TF_LEDStripV2 *led_strip_v2, char ret_uid[8], char ret_connected_uid[8], char *ret_position, uint8_t ret_hardware_version[3], uint8_t ret_firmware_version[3], uint16_t *ret_device_identifier) {
    ...
    if (result & TF_TICK_PACKET_RECEIVED && error_code == 0) {
        ...
        if (ret_uid != NULL) { tf_packet_buffer_pop_n(&led_strip_v2->tfp->spitfp->recv_buf, (uint8_t*)ret_uid, 8);} else { tf_packet_buffer_remove(&led_strip_v2->tfp->spitfp->recv_buf, 8); }
        tf_packet_buffer_pop_n(&led_strip_v2->tfp->spitfp->recv_buf, (uint8_t*)tmp_connected_uid, 8);
        if (ret_position != NULL) { *ret_position = tf_packet_buffer_read_char(&led_strip_v2->tfp->spitfp->recv_buf); } else { tf_packet_buffer_remove(&led_strip_v2->tfp->spitfp->recv_buf, 1); }
        if (ret_hardware_version != NULL) { for (i = 0; i < 3; ++i) ret_hardware_version[i] = tf_packet_buffer_read_uint8_t(&led_strip_v2->tfp->spitfp->recv_buf);} else { tf_packet_buffer_remove(&led_strip_v2->tfp->spitfp->recv_buf, 3); }
...
int tf_led_strip_v2_get_led_values(TF_LEDStripV2 *led_strip_v2, uint16_t index, uint16_t length, uint8_t *ret_value, uint16_t *ret_value_length) {
    ...
    if (!value_out_of_sync) {
        value_chunk_length = max_value_length - value_chunk_offset;
        ...
        value_length = value_chunk_length;

        while (value_length < max_value_length) {
            ret = tf_led_strip_v2_get_led_values_low_level(led_strip_v2, index, length, &value_length, &value_chunk_offset, value_chunk_data);
            ...
            value_out_of_sync = value_chunk_offset != value_length;
            ...
            if (ret_value != NULL) {
                memcpy(&ret_value[value_length], value_chunk_data, sizeof(uint8_t) * value_chunk_length);
            }
    ...
    if (value_out_of_sync) {
        ...
        while (value_chunk_offset + 60 < max_value_length) {
            ret = tf_led_strip_v2_get_led_values_low_level(led_strip_v2, index, length, &value_length, &value_chunk_offset, value_chunk_data);
