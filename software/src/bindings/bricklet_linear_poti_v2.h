...
#ifndef TF_LINEAR_POTI_V2_H
#define TF_LINEAR_POTI_V2_H
...
/**
 * \defgroup TF_LinearPotiV2 Linear Poti Bricklet 2.0
 */

struct TF_LinearPotiV2;
#if TF_IMPLEMENT_CALLBACKS != 0

typedef void (*TF_LinearPotiV2_PositionHandler)(struct TF_LinearPotiV2 *linear_poti_v2, uint8_t position, void *user_data);
...
typedef struct TF_LinearPotiV2 {
    TF_TFP *tfp;
#if TF_IMPLEMENT_CALLBACKS != 0
    TF_LinearPotiV2_PositionHandler position_handler;
 ...
 * \ingroup TF_LinearPotiV2
 *
 * Removes the device object \c linear_poti_v2 from its HAL and destroys it.
 ...
 * via the tf_linear_poti_v2_set_response_expected function. For setter
