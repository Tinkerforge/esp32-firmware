...
#endif
int tf_industrial_quad_relay_v2_create(TF_IndustrialQuadRelayV2 *industrial_quad_relay_v2, const char *uid_or_port_name, TF_HAL *hal) {
    ...
    TF_TFP *tfp;
    int rc = tf_hal_get_attachable_tfp(hal, &tfp, uid_or_port_name, TF_INDUSTRIAL_QUAD_RELAY_V2_DEVICE_IDENTIFIER);
...
int tf_industrial_quad_relay_v2_set_value(TF_IndustrialQuadRelayV2 *industrial_quad_relay_v2, const bool value[4]) {
    ...
    tf_industrial_quad_relay_v2_get_response_expected(industrial_quad_relay_v2, TF_INDUSTRIAL_QUAD_RELAY_V2_FUNCTION_SET_VALUE, &_response_expected);
    tf_tfp_prepare_send(industrial_quad_relay_v2->tfp, TF_INDUSTRIAL_QUAD_RELAY_V2_FUNCTION_SET_VALUE, 1, _response_expected);

    size_t _i;
    uint8_t *_send_buf = tf_tfp_get_send_payload_buffer(industrial_quad_relay_v2->tfp);
    ...
    if (_result & TF_TICK_TIMEOUT) {
        _result = tf_tfp_finish_send(industrial_quad_relay_v2->tfp, _result, _deadline);
        (void) _result;
        return TF_E_TIMEOUT;
    }
...
int tf_industrial_quad_relay_v2_get_value(TF_IndustrialQuadRelayV2 *industrial_quad_relay_v2, bool ret_value[4]) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(industrial_quad_relay_v2->tfp, TF_INDUSTRIAL_QUAD_RELAY_V2_FUNCTION_GET_VALUE, 0, _response_expected);
    ...
    if (_result & TF_TICK_PACKET_RECEIVED) {
        TF_PacketBuffer *_recv_buf = tf_tfp_get_receive_buffer(industrial_quad_relay_v2->tfp);
...
int tf_industrial_quad_relay_v2_set_monoflop(TF_IndustrialQuadRelayV2 *industrial_quad_relay_v2, uint8_t channel, bool value, uint32_t time) {
    ...
    bool _response_expected = true;
    tf_industrial_quad_relay_v2_get_response_expected(industrial_quad_relay_v2, TF_INDUSTRIAL_QUAD_RELAY_V2_FUNCTION_SET_MONOFLOP, &_response_expected);
    tf_tfp_prepare_send(industrial_quad_relay_v2->tfp, TF_INDUSTRIAL_QUAD_RELAY_V2_FUNCTION_SET_MONOFLOP, 6, _response_expected);
...
int tf_industrial_quad_relay_v2_get_monoflop(TF_IndustrialQuadRelayV2 *industrial_quad_relay_v2, uint8_t channel, bool *ret_value, uint32_t *ret_time, uint32_t *ret_time_remaining) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(industrial_quad_relay_v2->tfp, TF_INDUSTRIAL_QUAD_RELAY_V2_FUNCTION_GET_MONOFLOP, 1, _response_expected);
...
int tf_industrial_quad_relay_v2_set_selected_value(TF_IndustrialQuadRelayV2 *industrial_quad_relay_v2, uint8_t channel, bool value) {
    ...
    bool _response_expected = true;
    tf_industrial_quad_relay_v2_get_response_expected(industrial_quad_relay_v2, TF_INDUSTRIAL_QUAD_RELAY_V2_FUNCTION_SET_SELECTED_VALUE, &_response_expected);
    tf_tfp_prepare_send(industrial_quad_relay_v2->tfp, TF_INDUSTRIAL_QUAD_RELAY_V2_FUNCTION_SET_SELECTED_VALUE, 2, _response_expected);
...
int tf_industrial_quad_relay_v2_set_channel_led_config(TF_IndustrialQuadRelayV2 *industrial_quad_relay_v2, uint8_t channel, uint8_t config) {
    ...
    bool _response_expected = true;
    tf_industrial_quad_relay_v2_get_response_expected(industrial_quad_relay_v2, TF_INDUSTRIAL_QUAD_RELAY_V2_FUNCTION_SET_CHANNEL_LED_CONFIG, &_response_expected);
    tf_tfp_prepare_send(industrial_quad_relay_v2->tfp, TF_INDUSTRIAL_QUAD_RELAY_V2_FUNCTION_SET_CHANNEL_LED_CONFIG, 2, _response_expected);
...
int tf_industrial_quad_relay_v2_get_channel_led_config(TF_IndustrialQuadRelayV2 *industrial_quad_relay_v2, uint8_t channel, uint8_t *ret_config) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(industrial_quad_relay_v2->tfp, TF_INDUSTRIAL_QUAD_RELAY_V2_FUNCTION_GET_CHANNEL_LED_CONFIG, 1, _response_expected);
...
int tf_industrial_quad_relay_v2_get_spitfp_error_count(TF_IndustrialQuadRelayV2 *industrial_quad_relay_v2, uint32_t *ret_error_count_ack_checksum, uint32_t *ret_error_count_message_checksum, uint32_t *ret_error_count_frame, uint32_t *ret_error_count_overflow) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(industrial_quad_relay_v2->tfp, TF_INDUSTRIAL_QUAD_RELAY_V2_FUNCTION_GET_SPITFP_ERROR_COUNT, 0, _response_expected);
...
int tf_industrial_quad_relay_v2_set_bootloader_mode(TF_IndustrialQuadRelayV2 *industrial_quad_relay_v2, uint8_t mode, uint8_t *ret_status) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(industrial_quad_relay_v2->tfp, TF_INDUSTRIAL_QUAD_RELAY_V2_FUNCTION_SET_BOOTLOADER_MODE, 1, _response_expected);
...
int tf_industrial_quad_relay_v2_get_bootloader_mode(TF_IndustrialQuadRelayV2 *industrial_quad_relay_v2, uint8_t *ret_mode) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(industrial_quad_relay_v2->tfp, TF_INDUSTRIAL_QUAD_RELAY_V2_FUNCTION_GET_BOOTLOADER_MODE, 0, _response_expected);
...
int tf_industrial_quad_relay_v2_set_write_firmware_pointer(TF_IndustrialQuadRelayV2 *industrial_quad_relay_v2, uint32_t pointer) {
    ...
    bool _response_expected = true;
    tf_industrial_quad_relay_v2_get_response_expected(industrial_quad_relay_v2, TF_INDUSTRIAL_QUAD_RELAY_V2_FUNCTION_SET_WRITE_FIRMWARE_POINTER, &_response_expected);
    tf_tfp_prepare_send(industrial_quad_relay_v2->tfp, TF_INDUSTRIAL_QUAD_RELAY_V2_FUNCTION_SET_WRITE_FIRMWARE_POINTER, 4, _response_expected);
...
int tf_industrial_quad_relay_v2_write_firmware(TF_IndustrialQuadRelayV2 *industrial_quad_relay_v2, const uint8_t data[64], uint8_t *ret_status) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(industrial_quad_relay_v2->tfp, TF_INDUSTRIAL_QUAD_RELAY_V2_FUNCTION_WRITE_FIRMWARE, 64, _response_expected);
...
int tf_industrial_quad_relay_v2_set_status_led_config(TF_IndustrialQuadRelayV2 *industrial_quad_relay_v2, uint8_t config) {
    ...
    bool _response_expected = true;
    tf_industrial_quad_relay_v2_get_response_expected(industrial_quad_relay_v2, TF_INDUSTRIAL_QUAD_RELAY_V2_FUNCTION_SET_STATUS_LED_CONFIG, &_response_expected);
    tf_tfp_prepare_send(industrial_quad_relay_v2->tfp, TF_INDUSTRIAL_QUAD_RELAY_V2_FUNCTION_SET_STATUS_LED_CONFIG, 1, _response_expected);
...
int tf_industrial_quad_relay_v2_get_status_led_config(TF_IndustrialQuadRelayV2 *industrial_quad_relay_v2, uint8_t *ret_config) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(industrial_quad_relay_v2->tfp, TF_INDUSTRIAL_QUAD_RELAY_V2_FUNCTION_GET_STATUS_LED_CONFIG, 0, _response_expected);
...
int tf_industrial_quad_relay_v2_get_chip_temperature(TF_IndustrialQuadRelayV2 *industrial_quad_relay_v2, int16_t *ret_temperature) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(industrial_quad_relay_v2->tfp, TF_INDUSTRIAL_QUAD_RELAY_V2_FUNCTION_GET_CHIP_TEMPERATURE, 0, _response_expected);
...
int tf_industrial_quad_relay_v2_reset(TF_IndustrialQuadRelayV2 *industrial_quad_relay_v2) {
    ...
    bool _response_expected = true;
    tf_industrial_quad_relay_v2_get_response_expected(industrial_quad_relay_v2, TF_INDUSTRIAL_QUAD_RELAY_V2_FUNCTION_RESET, &_response_expected);
    tf_tfp_prepare_send(industrial_quad_relay_v2->tfp, TF_INDUSTRIAL_QUAD_RELAY_V2_FUNCTION_RESET, 0, _response_expected);
...
int tf_industrial_quad_relay_v2_write_uid(TF_IndustrialQuadRelayV2 *industrial_quad_relay_v2, uint32_t uid) {
    ...
    bool _response_expected = true;
    tf_industrial_quad_relay_v2_get_response_expected(industrial_quad_relay_v2, TF_INDUSTRIAL_QUAD_RELAY_V2_FUNCTION_WRITE_UID, &_response_expected);
    tf_tfp_prepare_send(industrial_quad_relay_v2->tfp, TF_INDUSTRIAL_QUAD_RELAY_V2_FUNCTION_WRITE_UID, 4, _response_expected);
...
int tf_industrial_quad_relay_v2_read_uid(TF_IndustrialQuadRelayV2 *industrial_quad_relay_v2, uint32_t *ret_uid) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(industrial_quad_relay_v2->tfp, TF_INDUSTRIAL_QUAD_RELAY_V2_FUNCTION_READ_UID, 0, _response_expected);
...
int tf_industrial_quad_relay_v2_get_identity(TF_IndustrialQuadRelayV2 *industrial_quad_relay_v2, char ret_uid[8], char ret_connected_uid[8], char *ret_position, uint8_t ret_hardware_version[3], uint8_t ret_firmware_version[3], uint16_t *ret_device_identifier) {
    ...
    bool _response_expected = true;
    tf_tfp_prepare_send(industrial_quad_relay_v2->tfp, TF_INDUSTRIAL_QUAD_RELAY_V2_FUNCTION_GET_IDENTITY, 0, _response_expected);
