...
void MetersRS485Bricklet::pre_setup()
{
    ...
    config_prototype = Config::Object({
        {"display_name", Config::Str(OPTIONS_METERS_RS485_BRICKLET_DEFAULT_DISPLAY_NAME(), 0, 32)},
    ...
    state_prototype = Config::Object({
        {"type", Config::Uint8(0)} // 0 - not available, 1 - sdm72, 2 - sdm630, 3 - sdm72v2, ... see meter.h
    });
