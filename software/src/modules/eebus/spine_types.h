...
struct MessagingTypeType { // EEBus_SPINE_TS_Messaging.xsd 
	std::optional<MessagingTypeEnumType> messagingtypeenumtype;
	std::optional<EnumExtendType> enumextendtype;
};
struct AbsoluteOrRelativeTimeType { // EEBus_SPINE_TS_CommonDataTypes.xsd 
	std::optional<std::string> duration;
	std::optional<std::string> datetime;
};
struct RecurringIntervalType { // EEBus_SPINE_TS_CommonDataTypes.xsd 
	std::optional<RecurringIntervalEnumType> recurringintervalenumtype;
	std::optional<EnumExtendType> enumextendtype;
};
struct OccurrenceType { // EEBus_SPINE_TS_CommonDataTypes.xsd 
	std::optional<OccurrenceEnumType> occurrenceenumtype;
	std::optional<EnumExtendType> enumextendtype;
};
struct CommodityTypeType { // EEBus_SPINE_TS_CommonDataTypes.xsd 
	std::optional<CommodityTypeEnumType> commoditytypeenumtype;
	std::optional<EnumExtendType> enumextendtype;
};
struct EnergyDirectionType { // EEBus_SPINE_TS_CommonDataTypes.xsd 
	std::optional<EnergyDirectionEnumType> energydirectionenumtype;
	std::optional<EnumExtendType> enumextendtype;
};
struct EnergyModeType { // EEBus_SPINE_TS_CommonDataTypes.xsd 
	std::optional<EnergyModeEnumType> energymodeenumtype;
	std::optional<EnumExtendType> enumextendtype;
};
struct UnitOfMeasurementType { // EEBus_SPINE_TS_CommonDataTypes.xsd 
	std::optional<UnitOfMeasurementEnumType> unitofmeasurementenumtype;
	std::optional<EnumExtendType> enumextendtype;
};
struct CurrencyType { // EEBus_SPINE_TS_CommonDataTypes.xsd 
	std::optional<CurrencyEnumType> currencyenumtype;
	std::optional<EnumExtendType> enumextendtype;
};
struct ScopeTypeType { // EEBus_SPINE_TS_CommonDataTypes.xsd 
	std::optional<ScopeTypeEnumType> scopetypeenumtype;
	std::optional<EnumExtendType> enumextendtype;
};
struct DeviceTypeType { // EEBus_SPINE_TS_CommonDataTypes.xsd 
	std::optional<DeviceTypeEnumType> devicetypeenumtype;
	std::optional<EnumExtendType> enumextendtype;
};
struct EntityTypeType { // EEBus_SPINE_TS_CommonDataTypes.xsd 
	std::optional<EntityTypeEnumType> entitytypeenumtype;
	std::optional<EnumExtendType> enumextendtype;
};
struct FeatureTypeType { // EEBus_SPINE_TS_CommonDataTypes.xsd 
	std::optional<FeatureTypeEnumType> featuretypeenumtype;
	std::optional<EnumExtendType> enumextendtype;
};
struct FeatureSpecificUsageType { // EEBus_SPINE_TS_CommonDataTypes.xsd 
	std::optional<std::string> featurespecificusageenumtype;
	std::optional<EnumExtendType> enumextendtype;
};
struct FeatureSpecificUsageEnumType { // EEBus_SPINE_TS_CommonDataTypes.xsd 
...
struct FunctionType { // EEBus_SPINE_TS_CommonDataTypes.xsd 
...
struct TimeSeriesTypeType { // EEBus_SPINE_TS_TimeSeries.xsd 
	std::optional<TimeSeriesTypeEnumType> timeseriestypeenumtype;
	std::optional<EnumExtendType> enumextendtype;
};
struct MeasurementTypeType { // EEBus_SPINE_TS_Measurement.xsd 
	std::optional<MeasurementTypeEnumType> measurementtypeenumtype;
	std::optional<EnumExtendType> enumextendtype;
};
struct MeasurementValueTypeType { // EEBus_SPINE_TS_Measurement.xsd 
	std::optional<MeasurementValueTypeEnumType> measurementvaluetypeenumtype;
	std::optional<EnumExtendType> enumextendtype;
};
struct MeasurementValueSourceType { // EEBus_SPINE_TS_Measurement.xsd 
	std::optional<MeasurementValueSourceEnumType> measurementvaluesourceenumtype;
	std::optional<EnumExtendType> enumextendtype;
};
struct MeasurementValueTendencyType { // EEBus_SPINE_TS_Measurement.xsd 
	std::optional<MeasurementValueTendencyEnumType> measurementvaluetendencyenumtype;
	std::optional<EnumExtendType> enumextendtype;
};
struct MeasurementValueStateType { // EEBus_SPINE_TS_Measurement.xsd 
	std::optional<MeasurementValueStateEnumType> measurementvaluestateenumtype;
	std::optional<EnumExtendType> enumextendtype;
};
struct ThresholdTypeType { // EEBus_SPINE_TS_Threshold.xsd 
...
struct DirectControlActivityStateType { // EEBus_SPINE_TS_DirectControl.xsd 
	std::optional<DirectControlActivityStateEnumType> directcontrolactivitystateenumtype;
	std::optional<EnumExtendType> enumextendtype;
};
struct PowerTimeSlotValueTypeType { // EEBus_SPINE_TS_PowerSequences.xsd 
	std::optional<PowerTimeSlotValueTypeEnumType> powertimeslotvaluetypeenumtype;
	std::optional<EnumExtendType> enumextendtype;
};
struct PowerSequenceScopeType { // EEBus_SPINE_TS_PowerSequences.xsd 
	std::optional<PowerSequenceScopeEnumType> powersequencescopeenumtype;
	std::optional<EnumExtendType> enumextendtype;
};
struct PowerSequenceStateType { // EEBus_SPINE_TS_PowerSequences.xsd 
...
struct ActuatorLevelFctType { // EEBus_SPINE_TS_ActuatorLevel.xsd 
...
struct StateInformationCategoryType { // EEBus_SPINE_TS_StateInformation.xsd 
	std::optional<StateInformationCategoryEnumType> stateinformationcategoryenumtype;
	std::optional<EnumExtendType> enumextendtype;
};
struct SupplyConditionEventTypeType { // EEBus_SPINE_TS_SupplyCondition.xsd 
	std::optional<SupplyConditionEventTypeEnumType> supplyconditioneventtypeenumtype;
	std::optional<EnumExtendType> enumextendtype;
};
struct SupplyConditionOriginatorType { // EEBus_SPINE_TS_SupplyCondition.xsd 
	std::optional<SupplyConditionOriginatorEnumType> supplyconditionoriginatorenumtype;
	std::optional<EnumExtendType> enumextendtype;
};
struct GridConditionType { // EEBus_SPINE_TS_SupplyCondition.xsd 
	std::optional<GridConditionEnumType> gridconditionenumtype;
	std::optional<EnumExtendType> enumextendtype;
};
struct TaskManagementJobStateType { // EEBus_SPINE_TS_TaskManagement.xsd 
	std::optional<DirectControlActivityStateEnumType> directcontrolactivitystateenumtype;
	std::optional<HvacOverrunStatusEnumType> hvacoverrunstatusenumtype;
	std::optional<LoadControlEventStateEnumType> loadcontroleventstateenumtype;
	std::optional<PowerSequenceStateEnumType> powersequencestateenumtype;
...
struct TaskManagementJobSourceType { // EEBus_SPINE_TS_TaskManagement.xsd 
