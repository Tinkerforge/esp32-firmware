                                      ...
                                      bool cp_disconnected_state)
{
    ...
    state_pkt.v3.phases |= (evse_common.backend->phase_switching_capable() && evse_common.backend->can_switch_phases_now(state_pkt.v3.phases == 1)) << CM_STATE_V3_CAN_PHASE_SWITCH_BIT_POS;
