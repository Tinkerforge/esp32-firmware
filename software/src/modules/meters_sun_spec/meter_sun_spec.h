...
{
public:
    MeterSunSpec(uint32_t slot_, Config *state_, Config *errors_, TFModbusTCPClientPool *pool_) : GenericModbusTCPClient(pool_), slot(slot_), state(state_), errors(errors_) {}
