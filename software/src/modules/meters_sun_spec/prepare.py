...
model_specs = [
    ...
    ModelSpec('Inverter Single Phase Integer',              'Inverter Single Phase',            'Wechselrichter Einphasig',            101,   True,  False),
    ModelSpec('Inverter Split Phase Integer',               'Inverter Split Phase',             'Wechselrichter Einphasig-Dreileiter', 102,   True,  False),
    ModelSpec('Inverter Three Phase Integer',               'Inverter Three Phase',             'Wechselrichter Dreiphasig',           103,   True,  False),
    ModelSpec('Inverter Single Phase Float',                'Inverter Single Phase',            'Wechselrichter Einphasig',            111,   True,  False),
    ModelSpec('Inverter Split Phase Float',                 'Inverter Split Phase',             'Wechselrichter Einphasig-Dreileiter', 112,   True,  False),
    ModelSpec('Inverter Three Phase Float',                 'Inverter Three Phase',             'Wechselrichter Dreiphasig',           113,   True,  False),
