...
model_specs = [
    ...
    ModelSpec('DER AC Measurements',                        'DER AC Measurements',              'DER AC Messwerte',                    701,   True,  True),
    ...
    ModelSpec('DER Storage Capacity',                       'DER Storage Capacity',             'DER Speicherkapazität',               713,   True,  True),
    ModelSpec('DER DC Measurements',                        'DER DC Measurements',              'DER DC Messwerte',                    714,   True,  True),
