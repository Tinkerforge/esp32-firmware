...
model_specs = [
    ...
    ModelSpec('Inverter Single Phase Integer',              'Inverter Single Phase',            'Inverter Einphasig',            101,   True,  True),
    ModelSpec('Inverter Split Phase Integer',               'Inverter Split Phase',             'Inverter Einphasig-Dreileiter', 102,   True,  True),
    ModelSpec('Inverter Three Phase Integer',               'Inverter Three Phase',             'Inverter Dreiphasig',           103,   True,  True),
    ModelSpec('Inverter Single Phase Float',                'Inverter Single Phase',            'Inverter Einphasig',            111,   True,  True),
    ModelSpec('Inverter Split Phase Float',                 'Inverter Split Phase',             'Inverter Einphasig-Dreileiter', 112,   True,  True),
    ModelSpec('Inverter Three Phase Float',                 'Inverter Three Phase',             'Inverter Dreiphasig',           113,   True,  True),
    ModelSpec('Inverter Nameplate',                         'FIXME',                            'FIXME',                         120,   False, False),
    ModelSpec('Inverter Basic Settings',                    'FIXME',                            'FIXME',                         121,   False, False),
    ModelSpec('Inverter Measurements And Status',           'Inverter Measurements and Status', 'Inverter Messwerte und Status', 122,   True,  False),
