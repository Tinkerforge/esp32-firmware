...
#define WEM_DATA_STORAGE_STATUS_OK          TF_WARP_ENERGY_MANAGER_DATA_STORAGE_STATUS_OK
#define WEM_DATA_STORAGE_STATUS_NOT_FOUND   TF_WARP_ENERGY_MANAGER_DATA_STORAGE_STATUS_NOT_FOUND
#define WEM_DATA_STORAGE_STATUS_BUSY        TF_WARP_ENERGY_MANAGER_DATA_STORAGE_STATUS_BUSY
...
#define WEM_DATA_STORAGE_STATUS_OK          TF_WARP_ENERGY_MANAGER_V2_DATA_STORAGE_STATUS_OK
#define WEM_DATA_STORAGE_STATUS_NOT_FOUND   TF_WARP_ENERGY_MANAGER_V2_DATA_STORAGE_STATUS_NOT_FOUND
