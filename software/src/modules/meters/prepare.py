...
file_lines.append('from enum import IntEnum\n\n')
file_lines.append('class MeterValueID(IntEnum):\n')
file_lines.append(''.join(x.replace(",", "").replace("//", " #") for x in value_id_enum))
file_lines.append('\nMVID = MeterValueID\n')

util.write_generated_file('generated/meter_value_id.py', ''.join(file_lines))
...
util.write_generated_file('generated/meter_value_id.h', ''.join(file_lines))
...
util.write_generated_file('generated/meter_value_id.cpp', ''.join(file_lines))
...
util.write_generated_file('../../../web/src/modules/meters/generated/meter_value_id.ts', ''.join(file_lines))
...
file_lines.append('#pragma once\n\n')
file_lines.append('#include "meter_value_id.h"\n\n')
file_lines.append('struct imexdiff_mapping {\n')
file_lines.append('    MeterValueID imexdiff;\n')
file_lines.append('    MeterValueID im;\n')
file_lines.append('    MeterValueID ex;\n')
file_lines.append('};\n\n')
file_lines.append('extern const imexdiff_mapping meter_value_imexdiff_mappings[];\n')
file_lines.append('extern const size_t meter_value_imexdiff_mappings_count;\n')

util.write_generated_file('generated/meter_value_imexdiff.h', ''.join(file_lines))
...
util.write_generated_file('generated/meter_value_imexdiff.cpp', ''.join(file_lines))
...
util.write_generated_file('../ocpp/generated/mvid_to_measurand.h', ocpp_lut_header.format(mvid_count=len(ocpp_map)))
util.write_generated_file('../ocpp/generated/mvid_to_measurand.cpp', ocpp_lut_template.format(mvid_count=len(ocpp_map), mappings='\n    '.join(ocpp_map)))
