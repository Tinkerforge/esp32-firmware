...
Ethernet::Ethernet()
{
    ...
    ethernet_state = Config::Object({
        {"connection_state", Config::Uint(EthernetState::NOT_CONFIGURED)},
        {"ip", Config::Str("0.0.0.0", 7, 15)},
...
void Ethernet::setup()
{
    ...
    ethernet_state.get("connection_state")->updateUint(EthernetState::NOT_CONFIGURED);
    ...
    ethernet_state.get("connection_state")->updateUint(EthernetState::NOT_CONNECTED);
    ...
    WiFi.onEvent([this](arduino_event_id_t event, arduino_event_info_t info) {
            ...
            ethernet_state.get("connection_state")->updateUint(EthernetState::CONNECTING);
        },
    ...
    WiFi.onEvent([this](arduino_event_id_t event, arduino_event_info_t info) {
            ...
            ethernet_state.get("connection_state")->updateUint(EthernetState::CONNECTED);
