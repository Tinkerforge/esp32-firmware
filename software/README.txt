...
- Install Python >= 3.12, Node.js >= 20 and NPM >= 9 (left as exercise for the reader)
...
- The firmwares are organized as PlatformIO environments:
  ...
  - "platformio run -e energy_manager_v2" builds the WARP Energy Manager 2.0 firmware
