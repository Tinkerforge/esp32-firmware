...
let x = {
    ...
    "component": {
        ...
        "ip_configuration": {
            ...
            "gateway": "Gateway",
            "gateway_muted": "0.0.0.0 falls rein lokales Netzwerk",
            "dns": "DNS-Server",
        ...
        "debug_logger": {
            ...
            "loading_coredump": "Lade Coredump",
            "loading_coredump_failed": "Laden des Coredumps fehlgeschlagen",
        ...
        "header_status": {
            "status": "Status",
            "legend_ok": "OK",
            "legend_warning": "Warnung",
            "legend_error": "Fehler",
            "legend_disabled": "Deaktiviert",
            "show_disabled": "Deaktivierte anzeigen"
        },
        "heating_curve_chart": {
            "temperature_daily_avg": "Tagesmitteltemperatur (°C)",
            "current_temperature": "Heutiger Durchschnitt",
            "curve_hours": "Stunden",
