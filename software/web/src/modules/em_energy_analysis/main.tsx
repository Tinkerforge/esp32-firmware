    ...
    render(props: {}, state: Readonly<EMEnergyAnalysisState>) {
        ...
        return (
            <SubPage name="em_energy_analysis" colClasses="col-xl-10">
                <PageHeader title={__("em_energy_analysis.content.em_energy_analysis")} titleClass="text-center text-sm-start text-nowrap" titleColClass="col-12 col-sm" childrenColClass="col-12 col-sm-auto mb-2">
