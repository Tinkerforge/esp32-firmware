    ...
    render(props: {}, state: Readonly<EMEnergyAnalysisState>) {
        ...
        return (
            <SubPage name="em_energy_analysis" colClasses="col-xl-10">
                <PageHeader title={__("em_energy_analysis.content.em_energy_analysis")} titleClass="col-12 col-sm text-center text-sm-start" childrenClass="col-12 col-sm-auto mb-2">
