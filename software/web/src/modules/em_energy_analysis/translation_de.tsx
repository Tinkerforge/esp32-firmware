...
let x = {
    "em_energy_analysis": {
        ...
        "content": {
            ...
            "state_phase": "Phasen",
            "state_input1": "Eingang 1",
            "state_input2": "Eingang 2",
            ...
            "state_sg_ready_open": "Offen",
            "state_sg_ready_closed": "Geschlossen",
            "state_sg_ready_inactive": "Inaktiv",
            "state_sg_ready_active": "Aktiv",
            "state_relay": "Relais",
            "state_relay1": "Relais 1",
            "state_relay2": "Relais 2",
            ...
            "state_charging": "Lädt",
            "state_error": "Fehler",
            "state_charging_single_phase": "Lädt einphasig",
            "state_charging_three_phase": "Lädt dreiphasig",
        ...
        "script": {
            ...
            "power": "Leistung",
            "price": "Strompreis",
            "price_min": "Strompreis (Minimum)",
            "price_avg": "Strompreis (Mittel)",
            "price_max": "Strompreis (Maximum)",
            "energy": "Energie",
