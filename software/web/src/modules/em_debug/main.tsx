            ...
            <SubPage name="em_debug">
                ...
                <FormRow label={__("em_debug.content.reset_description")} label_muted={__("em_debug.content.reset_description_muted")}>
                    <div class="input-group pb-2">
                        <Button variant="primary" className="form-control rounded-end me-2" onClick={() => API.call('energy_manager/reset', {}, () => "")}>{__("em_debug.content.reset_em")}</Button>
                        <Button variant="primary" className="form-control rounded-start" onClick={() => API.call('energy_manager/reflash', {}, () => "")}>{__("em_debug.content.reflash_em")}</Button>
                    </div>
                </FormRow>
