...
let x = {
    "p14a_enwg": {
        ...
        "content": {
            ...
            "enable_p14a_enwg_desc": "§14a EnWG control signals are received and processed.",
            ...
            "source_eebus": "EEBUS",
            "source_api": "API",
            "eebus_needs_activation": <>To be able to use EEBUS as signal source, <a href="#eebus">EEBUS</a> must be enabled.</>,
            "input": "Input",
            "limit": "Device count",
