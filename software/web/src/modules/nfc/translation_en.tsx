...
let x = {
    "nfc": {
        ...
        "content": {
            ...
            "type_6": "Smartphone",
            "tap_to_unlock": "Android tap-to-unlock",
            "tap_to_unlock_no_app": "To use your smartphone for tap-to-unlock, open this page in the WARP app on an Android device.",
            "tap_to_unlock_ios": "Tap-to-unlock is only available for Android devices. Apple does not allow NFC host card emulation on iOS.",
            "tap_to_unlock_not_supported": "Your smartphone does not support NFC host card emulation or your need to update your WARP app.",
            "tap_to_unlock_add": "Add your smartphone",
            "tap_to_unlock_your_id": "Your tag ID: ",
            "tap_to_unlock_add_btn": "Add",
            "tap_to_unlock_activated": "This smartphone is already registered for tap-to-unlock.",
