...
let x = {
    "nfc": {
        ...
        "content": {
            ...
            "type_6": "Smartphone",
            "tap_to_unlock": "Charge authorization via smartphone",
            ...
            "tap_to_unlock_your_id": "Your smartphone's tag ID: ",
            "tap_to_unlock_add_btn": "Add",
            "tap_to_unlock_activated": "This smartphone is registered for charge authorization. Unlock your phone and hold it to the charger instead of an NFC tag.",
