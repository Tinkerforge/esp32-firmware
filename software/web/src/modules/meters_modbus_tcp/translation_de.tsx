...
let x = {
    "meters_modbus_tcp": {
        ...
        "content": {
            ...
            "table_deye_hybrid_inverter_low_voltage": "Deye Hybrid-Wechselrichter (Niederspannungsbatterie)",
            "table_deye_hybrid_inverter_high_voltage": "Deye Hybrid-Wechselrichter (Hochspannungsbatterie)",
            ...
            "registers_value_type_u16": "16-Bit, Ganzzahl, vorzeichenlos",
            "registers_value_type_s16": "16-Bit, Ganzzahl, vorzeichenbehaftet",
            "registers_value_type_u32be": "32-Bit, Ganzzahl, vorzeichenlos, Big-Endian",
            "registers_value_type_u32le": "32-Bit, Ganzzahl, vorzeichenlos, Little-Endian",
            "registers_value_type_s32be": "32-Bit, Ganzzahl, vorzeichenbehaftet, Big-Endian",
            "registers_value_type_s32le": "32-Bit, Ganzzahl, vorzeichenbehaftet, Little-Endian",
            "registers_value_type_u64be": "64-Bit, Ganzzahl, vorzeichenlos, Big-Endian",
            "registers_value_type_u64le": "64-Bit, Ganzzahl, vorzeichenlos, Little-Endian",
            "registers_value_type_s64be": "64-Bit, Ganzzahl, vorzeichenbehaftet, Big-Endian",
            "registers_value_type_s64le": "64-Bit, Ganzzahl, vorzeichenbehaftet, Little-Endian",
            "registers_value_type_f32be": "32-Bit, Gleitkommazahl, Big-Endian",
            "registers_value_type_f32le": "32-Bit, Gleitkommazahl, Little-Endian",
            "registers_value_type_f64be": "64-Bit, Gleitkommazahl, Big-Endian",
            "registers_value_type_f64le": "64-Bit, Gleitkommazahl, Little-Endian",
