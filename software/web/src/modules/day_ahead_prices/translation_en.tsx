...
let x = {
    "day_ahead_prices": {
        ...
        "content": {
            ...
            "mode": "Mode",
            "mode_automatic_desc": /*FFN*/(api_url: string) => <>The data is provided by <a href="https://www.entsoe.eu/about/" target="_blank">ENTSO-E</a> and fetched from <a href={api_url}>{api_url.replace("https://", "").replace(/\/$/, "")}</a>.</>/*NF*/,
            "mode_automatic": "Automatic via ENTSO-E",
            "mode_push": "Push via API",
            "mode_push_desc": <>In push mode, price data is provided via the API endpoint <a href="https://docs.warp-charger.com/docs/interfaces/mqtt_http/api_reference/day_ahead_prices" target="_blank">day_ahead_prices/prices_update</a>.</>,
            "region": "Region",
            "germany": "Germany",
            "austria": "Austria",
