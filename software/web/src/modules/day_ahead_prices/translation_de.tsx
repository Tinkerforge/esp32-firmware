...
let x = {
    "day_ahead_prices": {
        ...
        "content": {
            ...
            "mode": "Modus",
            "mode_automatic_desc": /*FFN*/(api_url: string) => <>Die Daten werden von <a href="https://www.entsoe.eu/about/" target="_blank">ENTSO-E</a> bereitgestellt und über <a href={api_url}>{api_url.replace("https://", "").replace(/\/$/, "")}</a> bezogen.</> /*NF*/,
            "mode_automatic": "Automatisch über ENTSO-E",
            "mode_push": "Push über API",
            "mode_push_desc": <>Im Push-Modus werden Preisdaten über den API-Endpunkt <a href="https://docs.warp-charger.com/docs/interfaces/mqtt_http/api_reference/day_ahead_prices" target="_blank">day_ahead_prices/prices_update</a> bereitgestellt.</>,
            "region": "Region",
            "germany": "Deutschland",
            "austria": "Österreich",
