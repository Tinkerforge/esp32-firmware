...
let x = {
    "batteries_modbus_tcp": {
        ...
        "content": {
            ...
            "battery_mode_disable": "Kein Laden, kein Entladen",
            "battery_mode_normal": "Normales Laden, normales Entladen",
            "battery_mode_charge_from_excess": "Normales Laden, kein Entladen",
            "battery_mode_charge_from_grid": "Erzwungenes Laden, kein Entladen",
            "battery_mode_discharge_to_load": "Kein Laden, normales Entladen",
            "battery_mode_discharge_to_grid": "Kein Laden, erzwungenes Entladen",
            "grid_draw_setpoint_normal": "Sollwert Netzbezug (normal)",
            "grid_draw_setpoint_charge": "Sollwert Netzbezug (erzwungenes Laden)",
            "grid_draw_setpoint_discharge": "Sollwert Netzbezug (erzwungenes Entladen)",
            "max_soc": "Maximaler Ladestand",
            "min_soc": "Minimaler Ladestand",
            "grid_charge_power": "Netzbezugsleistung",
            "grid_discharge_power": "Netzeinspeiseleistung",
