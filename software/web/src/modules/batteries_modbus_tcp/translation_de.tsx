...
let x = {
    "batteries_modbus_tcp": {
        ...
        "content": {
            ...
            "table_sma_hybrid_inverter_40793": "SMA Hybrid-Wechselrichter (40793)",
            "table_sma_hybrid_inverter_41467": "SMA Hybrid-Wechselrichter (41467)",
            "sma_forecast_based_charging_warning": <>Das SMA eigene <a href={removeUnicodeHacks("https://manuals.sma.de/HM-20/de-DE/8644254859.html")}>prognosebasierte Batterieladen</a> kann die Batteriesteuerung beinträchtigen. Bitte sicherstellen, dass das prognosebasierte Batterieladen im SMA Sunny Portal deaktiviert ist.</>,
            "sma_energy_management_warning": <>Das SMA eigene Energiemanagement des Hybrid-Wechselrichters kann die Batteriesteuerung beinträchtigen. Bitte sicherstellen, dass das Energiemanagement des Hybrid-Wechselrichters deaktiviert ist.</>,
