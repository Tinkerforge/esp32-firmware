...
let x = {
    "batteries_modbus_tcp": {
        ...
        "content": {
            ...
            "sax_power_home_basic_mode_register_warning": <>Bitte sicherstellen, dass die Modbus/TCP-Register 40044/40045 (43/44) beim SAX Power Home Batteriespeicher freigeschaltet sind.</>,
            "sax_power_home_basic_mode_force_warning": <>Bedingt durch die limitierte Steuerbarkeit des SAX Power Home Batteriespeicher, können Laden und Entladen nicht erwungen werden. Stattdessen wird in diesen fällen das Laden bzw. Entladen auf normal belassen.</>,
