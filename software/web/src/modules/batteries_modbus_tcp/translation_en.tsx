...
let x = {
    "batteries_modbus_tcp": {
        ...
        "content": {
            ...
            "sma_forecast_based_charging_warning": <>SMA's own <a href={removeUnicodeHacks("https://manuals.sma.de/HM-20/de-DE/8644254859.html")}>forecast-based charging</a> might interfere with the battery control. Please ensure that forecast-based charging is disabled in the SMA Sunny Portal.</>,
