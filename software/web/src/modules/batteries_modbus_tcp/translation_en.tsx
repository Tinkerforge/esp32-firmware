...
let x = {
    "batteries_modbus_tcp": {
        ...
        "content": {
            ...
            "table_solis_hybrid_inverter": "Solis hybrid inverter",
            ...
            "sax_power_home_basic_mode_register_warning": <>Please ensure that the Modbus/TCP registers 40044/40045 (43/44) of the SAX Power Home battery storage are enabled.</>,
            "sax_power_home_basic_mode_force_warning": <>Due to limited controllability of the SAX Power Home battery storage, it is not possible to force charge and force discharge. Instead charge and discharge are left at normal in this cases.</>,
