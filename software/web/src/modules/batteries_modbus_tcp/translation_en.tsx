...
let x = {
    "batteries_modbus_tcp": {
        ...
        "content": {
            ...
            "battery_mode_disable": "No charge, no discharge",
            "battery_mode_normal": "Normal charge, normal discharge",
            "battery_mode_charge_from_excess": "Normal charge, no discharge",
            "battery_mode_charge_from_grid": "Forced charge, no discharge",
            "battery_mode_discharge_to_load": "No charge, normal discharge",
            "battery_mode_discharge_to_grid": "No charge, forced discharge",
            "grid_draw_setpoint_normal": "Grid draw setpoint (normal)",
            "grid_draw_setpoint_charge": "Grid draw setpoint (forced charge)",
            "grid_draw_setpoint_discharge": "Grid draw setpoint (forced discharge)",
            "max_soc": "Maximum state of charge",
            "min_soc": "Minimum state of charge",
            "grid_charge_power": "Grid charge power",
            "grid_discharge_power": "Grid discharge power",
