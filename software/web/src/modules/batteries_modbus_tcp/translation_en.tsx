...
let x = {
    "batteries_modbus_tcp": {
        ...
        "content": {
            ...
            "table_sma_hybrid_inverter_40793": "SMA hybrid inverter (40793)",
            "table_sma_hybrid_inverter_41467": "SMA hybrid inverter (41467)",
            "sma_forecast_based_charging_warning": <>SMA's own <a href={removeUnicodeHacks("https://manuals.sma.de/HM-20/en-US/8644254859.html")}>forecast-based charging</a> might interfere with the battery control. Please ensure that forecast-based charging is disabled in the SMA Sunny Portal.</>,
            "sma_energy_management_warning": <>SMA's own energy management of the hybrid inverter might interfere with the battery control. Please ensure that the energy management of the hybrid inverter is disabled.</>,
