...
let x = {
    "power_manager": {
        ...
        "content": {
            ...
            "enable_excess_charging_help": /*FFN*/() => options.WARP_DOC_BASE_URL.length > 0 ? <p>Das <a href={`${options.WARP_DOC_BASE_URL}/de/docs/tutorials/pv_excess_charging`}>Tutorial PV-Überschussladen</a> hilft bei der Einrichtung.</p> : undefined/*NF*/,
            ...
            "meter_slot_grid_power_muted": "am Netzanschluss",
            ...
            "meter_slot_grid_power_incorrect_location": "kein Netzbezugszähler",
            ...
            "meter_slot_battery_power_incorrect_location": "kein Batteriezähler",
            "battery_priority": "Speicherpriorität",
            "battery_priority_prefer_chargers": "Wallboxen bevorzugen, überschüssige Leistung für Speicher",
            "battery_priority_prefer_battery": "Speicher bevorzugen, überschüssige Leistung für Wallboxen",
            "battery_priority_target_soc": "Speicher bevorzugen, solange der Ladestand unter dem Zielwert liegt",
