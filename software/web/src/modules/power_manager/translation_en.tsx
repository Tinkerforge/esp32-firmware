...
let x = {
    "power_manager": {
        ...
        "content": {
            ...
            "target_power_n50_without_battery_meter": "Slightly conservative (− 50 W) – charges battery bank first",
            "target_power_0_with_battery_meter": "Balanced (± 0 W)",
            "target_power_0_without_battery_meter": "Balanced (± 0 W) – recommended with no battery bank",
            "target_power_p50_with_battery_meter": "Slightly aggressive (+ 50 W)",
            "target_power_p50_without_battery_meter": "Slightly aggressive (+ 50 W) – uses battery bank to charge vehicle",
