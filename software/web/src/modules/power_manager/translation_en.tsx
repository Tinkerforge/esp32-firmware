...
let x = {
    "power_manager": {
        ...
        "content": {
            ...
            "enable_excess_charging_help": /*FFN*/() => options.WARP_DOC_BASE_URL.length > 0 ? <p>The <a href={`${options.WARP_DOC_BASE_URL}/en/docs/tutorials/pv_excess_charging`}>tutorial PV-excess-charging</a> helps configuring this.</p> : undefined/*NF*/,
            ...
            "meter_slot_grid_power_muted": "at the grid connection",
            ...
            "meter_slot_grid_power_incorrect_location": "not a grid meter",
            ...
            "meter_slot_battery_power_incorrect_location": "not a battery meter",
            "battery_priority": "Battery priority",
            "battery_priority_prefer_chargers": "Prefer chargers, charge battery storage with any excess power",
            "battery_priority_prefer_battery": "Prefer battery, charge vehicles with any excess power",
            "battery_priority_target_soc": "Prefer battery while it is below the target state of charge",
            "battery_target_soc": "Storage target state of charge",
        ...
        "automation": {
            ...
            "automation_limit_max_current_action_text": /*FFN*/(current: number, default_current: number) => {
                if (current === -1) {
                    return <>reset maximum total current limit to the configured default current (<b>{toLocaleFixed(default_current / 1000)} A</b>).</>
                }
                return <>limit maximum total current to <b>{toLocaleFixed(current / 1000)} A</b>.</>
            }/*NF*/,
