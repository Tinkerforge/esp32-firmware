    ...
    render(props: {}, s: Readonly<API.getType['power_manager/config']>) {
        ...
        return (
            <SubPage name="pv_excess_settings">
                <ConfigForm id="pv_excess_config_form" title={__("power_manager.content.header_excess_charging" )} isDirty={this.isDirty()} onSave={this.save} onDirtyChange={this.setDirty}>
