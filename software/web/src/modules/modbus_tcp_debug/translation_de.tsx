...
let x = {
    "modbus_tcp_debug": {
        ...
        "content": {
            ...
            "server_missing_github": <>, siehe <a href="https://github.com/Tinkerforge/esp32-firmware/issues/215">GitHub Issue #215</a></>,

            "debug": "Debug-Client",
            "expert_warning": "Dies ist ein Werkzeug für fortgeschrittene Benutzer. Es dient dem Debuggen und Explorieren der Modbus/TCP-Kommunikation mit anderen Modbus/TCP-Geräten. Es ist nicht notwendig den Debug-Client für den normalen Betrieb zu verwenden.",
            "meter": "Stromzähler",
            ...
            "function_code_write_single_coil": "5 – Einzelne Coil schreiben",
            "function_code_write_single_register": "6 – Einzelnes Register schreiben",
            "function_code_write_multiple_coils": "15 – Mehrere Coils schreiben",
