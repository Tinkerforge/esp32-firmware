...
let x = {
    "modbus_tcp_debug": {
        ...
        "content": {
            ...
            "server_missing_github": <>, see <a href="https://github.com/Tinkerforge/esp32-firmware/issues/215">GitHub issue #215</a></>,
            ...
            "function_code_write_single_coil": "5 – Write single coil",
            "function_code_write_single_register": "6 – Write single register",
            "function_code_write_multiple_coils": "15 – Write multiple coils",
            ...
            "function_code_read_mask_write_single_register": "3 + 6 – Read, mask and write single register",
            "function_code_read_mask_write_multiple_register": "3 + 16 – Read, mask and write multiple registers",
            ...
            "start_number_dec": "Start number (decimal)",
            "start_number_hex": "Start number (hexadecimal)",
            "start_number_hex_invalid": "Must consist of 1 to 4 hexadecimal digits",
            "data_count": "Count",
            ...
            "write_data_single_mask": "Bitmask",
            "write_data_single_mask_invalid": "The bitmask must be a sequence of 0, 1 or x.",
            "write_data_multiple_masks": "Bitmasks",
            "write_data_multiple_masks_muted": "comma-separated",
            "write_data_multiple_masks_invalid": "The bitmasks must be a comma-separated list of sequences of 0, 1 or x.",
