...
let x = {
    "charge_manager": {
        ...
        "script": {
            ...
            "opd_no_phase_improvement": /*SFN*/ (timespan: string, phase: number, allocable: number, minimum: number) => `Warte ${timespan} auf mehr ${__("charge_manager.script.phase_current")(phase)}: Bis zu ${allocable - minimum} mA können zusätzlich auf bereits aktive Wallboxen verteilt werden.` /*NF*/,
            ...
            "tpd_no_phase_improvement": /*SFN*/ (timespan: string, phase: number, allocable: number, minimum: number) => `Warte ${timespan} auf mehr ${__("charge_manager.script.phase_current")(phase)}: Bis zu ${allocable - minimum} mA können zusätzlich auf bereits aktive Wallboxen verteilt werden.` /*NF*/,
