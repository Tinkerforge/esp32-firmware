        ...
        "content": {
            ...
            "enable_charge_manager_help": <>
                ...
                <ul class="mb-0">
                    ...
                    <li><strong>Charge manager / PV excess charging:</strong> The charger functions as a charge manager. This also applies when it is solely used for <a href={removeUnicodeHacks("{{{doc_base_url}}}/docs/tutorials/pv_excess_charging/")}>PV excess charging</a>. Additional settings must be configured.</li>
                </ul>
            </>,
