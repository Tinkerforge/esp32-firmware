...
//#ifn MODULE_EVSE_COMMON_AVAILABLE
import { PageHeader } from "../../ts/components/page_header";
//#endif

export const EvSymbol = <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
{/*#else*/}
                {/* Without a SubPage.Status section, there is no header. Add one explicitly for WEM. */}
                <PageHeader title={__("ev.content.ev")} />
{/*#endif*/}
