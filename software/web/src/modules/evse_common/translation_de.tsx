...
let x = {
    "evse": {
        ...
        "content": {
            ...
            "error_state_help": <>
                <ul>
                    <li><p><strong>Schalterfehler:</strong> Die Wallbox wurde nicht korrekt installiert. Die Schaltereinstellung des Ladecontrollers ist noch auf dem Werkszustand.{options.WARP_DOC_BASE_URL.length > 0 ? <span> Siehe <a href={`${options.WARP_DOC_BASE_URL}/de/docs/warp_charger/assembly_and_installation#einstellen-des-ladestroms`}>Einstellen des Ladestroms</a>.</span> : undefined}</p></li>
