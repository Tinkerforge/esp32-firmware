...
let x = {
    "evse": {
        ...
        "content": {
            ...
            "error_state_help": <>
                <ul class="mb-0">
                    <li><p><strong>Schalterfehler: </strong>Die Wallbox wurde nicht korrekt installiert. Die Schaltereinstellung des Ladecontrollers ist noch auf dem Werkszustand. Siehe <a href="{{{doc_base_url}}}/docs/warp_charger/assembly_and_installation#einstellen-des-ladestroms">Einstellen des Ladestroms</a>.</p></li>
