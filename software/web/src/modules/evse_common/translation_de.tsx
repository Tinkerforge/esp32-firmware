...
let x = {
    "evse": {
        ...
        "content": {
            ...
            "auto_start_enable_central_auth": /*FFN*/(manager_ip: string) => <>Deaktiviert, weil die <a href={`http://${manager_ip}/#charge_manager_chargers`}>zentrale Ladefreigabe</a> im Lastmanager aktiviert ist.</>/*NF*/,
