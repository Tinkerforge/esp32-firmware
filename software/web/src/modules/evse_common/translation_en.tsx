...
let x = {
    "evse": {
        ...
        "content": {
            ...
            "auto_start_enable_central_auth": /*FFN*/(manager_ip: string) => <>Disabled because <a href={`http://${manager_ip}/#charge_manager_chargers`}>central authorization</a> is enabled in the charge manager.</>/*NF*/,
