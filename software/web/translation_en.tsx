...
let x = {
    ...
    "component": {
        ...
        "ip_configuration": {
            ...
            "dns2_muted": "optional",
            "static_ip_invalid": "The IP address must have four groups between 0 and 255 separated with a dot. For example 10.0.0.2. CIDR notation (z.B. /24) is allowed for subnet masks.",
            "static_ipv6_invalid": "The IP address must be a valid IPv6 address. CIDR notation (z.B. /64) is allowed for subnet masks.",
        ...
        "item_modal": {
            ...
            "import_error_no_file": "No file selected.",
            "import_error_wrong_file_type": "Selected file is not a JSON file.",
            "import_error_file_read_error": "Could not read file.",
