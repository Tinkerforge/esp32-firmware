...
def main():
    ...
    for suffix in ['warp', 'warp2', 'warp3', 'energy_manager', 'energy_manager_v2', 'smart_energy_broker', 'eltako']:
    ...
    write_firmware_info(product_id, json.loads(options_value['product_name']), version, build_timestamp)
